#  This is file bvt_activities_fetchAccess.py
#
...
# TEST TARGETS:     Run the AccessControlService.fetchAccess mbean command
...
#Globals
UNIQUE_SCRIPT_ID = "bvt_activities_fetchAccess"
...
def BvtFetchAccess():
   print ""
   print "--------------------------------------------------------------------------------"
   print " BVT Test Script for AccessControlService.fetchAccess(activity)MBean command."
...
#  Get the access list (acl) sort key
...
#  Sort the returned activities
   ...
   print "This command will fetch the access list for the 1st Activity, which should be..."
   ...
   print "This command will fetch the access list for the 2nd Activity, which should be..."
...
bvtActivitiesCommon=BvtActivitiesCommon()
print "BVT Fetch Access List test ... starting."

#-------------------------------------------------
# Main  - just execute the Activity test function
#-------------------------------------------------
print "BVT Fetch Activities Access List Test ... calling BvtFetchAccess()"
