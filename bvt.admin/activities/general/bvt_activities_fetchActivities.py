#  This is bvt_activities_fetchActivities.py
#
...
# TEST TARGETS:     ActivityService.fetchActivities()
...
#Globals
UNIQUE_SCRIPT_ID = "bvt_activities_fetchActivities"
...
def BvtActivitiesFetchActivities():
   print ""
   print "--------------------------------------------------------------------------------"
   print " BVT Test Script for fetching ALL activities using the Activity service MBean"
   ...
   print ""
   print "ActivityService.fetchActivities() Fetches ALL activities, except for those in the trash..."
   print ""
   print "List ALL Activities, should return 3 activities"
   ...
   sortedActivities = strUtil.sortHashTableVectorByKey( all, activitySortKey, 0)
...
bvtActivitiesCommon=BvtActivitiesCommon()
print "BVT Fetch Activities Test ... starting."

#-------------------------------------------------
# Main  - just execute the Activity test function
#-------------------------------------------------
print "BVT Fetch Activities Test ... calling BvtActivitiesFetchActivities()"
