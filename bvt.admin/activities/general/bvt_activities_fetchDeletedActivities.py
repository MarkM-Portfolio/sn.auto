#  This is bvt_activities_fetchDeletedActivities.py
#
...
# TEST TARGETS:     ActivityService.fetchDeletedActivities()
...
#Globals
UNIQUE_SCRIPT_ID = "bvt_activities_fetchDeletedActivities"
...
def BvtActivitiesFetchDeletedActivities():
   print ""
   print "--------------------------------------------------------------------------------"
   print " BVT Test Script for fetching deleted activities using the Activity service MBean"
...
#  Get the activity sort key
   ...
   activities = ActivityService.fetchDeletedActivities()
   print ""
...
bvtActivitiesCommon=BvtActivitiesCommon()
print "BVT Fetch Deleted Activities Test ... starting."

#-------------------------------------------------
# Main  - just execute the Activity test function
#-------------------------------------------------
print "BVT Fetch Deleted Activities Test ... calling BvtActivitiesFetchDeletedActivities()"
if DEBUG_SCRIPT != None:
   ...
   BvtActivitiesFetchDeletedActivities()
   global fErrorFile
   fErrorFile.close()
   os.unlink(ERRORFILE)
else:	
