#  This is:  bvt_activities_fetchMemberByLoginName.py
#
...
# AUTHOR:           yees@us.ibm.com  (based on Denise's bvt_activities_fetchMemberByName.py)
# INITIAL RELEASE:  LC2.5
# TEST TARGETS:     Run the MemberService.fetchMemberByLogin mbean command
...
#Globals
UNIQUE_SCRIPT_ID = "bvt_activities_fetchMemberByLoginName"
...
def BvtMembersInit():
   print ""
   print "--------------------------------------------------------------------------------"
   print " BVT Test Script for MemberService.fetchMemberByLogin(Amy Jones14)MBean command."
   ...
   print ""
   print "Issuing the command MemberService.fetchMemberByLogin('Amy Jones14')..."
   print "The command should return info about Amy Jones14 only..."
   aj14=MemberService.fetchMemberByLogin("Amy Jones14")
   print ""
   
   
   # count = BvtMembersCommon.listOneMember(bvtMembersCommon, aj14)
   BvtMembersCommon.listOneMember(bvtMembersCommon, aj14)
   ...
   BvtMembersCommon.writeOneMemberToFile(bvtMembersCommon, RUNFILE, aj14, flags)
