#  This is:  bvt_activities_fetchMemberByName.py
#
...
# TEST TARGETS:     Run the MemberService.fetchMemberByName mbean command
...
#Globals
UNIQUE_SCRIPT_ID = "bvt_activities_fetchMemberByName"
...
def BvtMembersInit():
   print ""
   print "--------------------------------------------------------------------------------"
   print " BVT Test Script for MemberService.fetchMemberByName(Amy Jones6)MBean command."
   ...
   print ""
   print "Issuing the command MemberService.fetchMemberByName('Amy Jones6')..."
   print "The command should return info about Amy Jones6 only..."
   aj6=MemberService.fetchMemberByName("Amy Jones6")
   print ""
   
   
   # count = BvtMembersCommon.listOneMember(bvtMembersCommon, aj6)
   BvtMembersCommon.listOneMember(bvtMembersCommon, aj6)
   ...
   BvtMembersCommon.writeOneMemberToFile(bvtMembersCommon, RUNFILE, aj6, flags)
