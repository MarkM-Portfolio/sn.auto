#  bvt_activities_fetch_metrics_snapshot.py
#
#  Jython Script to test some Activity commands on IBM Activities Enterprise Application
#  (C) Copyright IBM Corporation, 2008
#
#  DESCRIPTION:
#  This script takes a snapshot of Activities metrics and writes it to the file:
#  activitiesMetricsSnapshot.txt.  The purpose of the snapshot file is to allow the 
...
#Globals
UNIQUE_SCRIPT_ID = "bvt_activities_fetch_metrics_snapshot"
...
def BvtActivitiesFetchMetricsSnapshot():
   print ""
   print "--------------------------------------------------------------------------------"
   print " BVT Test Script for Producing an Activities Metrics Snapshot at the time this script is invoked "
   ...
   print ""
   print "Fetching Activities Metrics Snapshot . . ."
   activitiesMetricsSnapshot = ActivityMetricsService.fetchMetrics()   
   print ""

   print ""
   print "Activities Metrics Snapshot Data . . ."
   bvtMetricsCommon.listAllMetrics(activitiesMetricsSnapshot)
   print ""
   
   print ""
   print "Writing Activities Metrics Snapshot Data to snapshot file: " + SNAPSHOTFILE + " . . ."
   bvtMetricsCommon.writeMetricsToFile(SNAPSHOTFILE, activitiesMetricsSnapshot, None)
   print ""
...
bvtMetricsCommon=BvtMetricsCommon()
print "BVT BvtActivitiesFetchMetricsSnapshot ... starting."

#-------------------------------------------------
# Main  - just execute the BvtActivitiesFetchMetricsSnapshot test function
#-------------------------------------------------
print "BVT BvtActivitiesFetchMetricsSnapshot ... calling BvtActivitiesFetchMetricsSnapshot()"
if DEBUG_SCRIPT != None:
   ...
   BvtActivitiesFetchMetricsSnapshot()
   global fErrorFile
   fErrorFile.close()
   os.unlink(ERRORFILE)
else:	
