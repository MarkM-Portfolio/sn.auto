#  This is bvt_blogs_fetch_metrics_snapshot.py
#
#  Jython Script to test Blogs Metrics commands on IBM Blogs Enterprise Application
#  (C) Copyright IBM Corporation, 2008
#
#  DESCRIPTION:
#  This script takes a snapshot of Blogs metrics and writes it to the file:
#  blogsMetricsSnapshot.txt.  The purpose of the snapshot file is to allow the 
...
#  blogs contributes to the correct metrics values when processed by the test validation.
#
...
#Globals
UNIQUE_SCRIPT_ID = "bvt_blogs_fetch_metrics_snapshot"
...
def BvtBlogsFetchMetricsSnapshot():
   print ""
   print "--------------------------------------------------------------------------------"
   print " BVT Test Script for Producing an Blogs Metrics Snapshot at the time this script is invoked "
   ...
   print ""
   print "Fetching Blogs Metrics Snapshot . . ."
   blogsMetricsSnapshot = BlogsMetricsService.fetchMetrics()   
   print ""

   print ""
   print "Blogs Metrics Snapshot Data . . ."
   bvtMetricsCommon.listAllMetrics(blogsMetricsSnapshot)
   print ""
   
   print ""
   print "Writing Blogs Metrics Snapshot Data to snapshot file: " + SNAPSHOTFILE + " . . ."
   bvtMetricsCommon.writeMetricsToFile(SNAPSHOTFILE, blogsMetricsSnapshot, None)
   print ""
...
bvtMetricsCommon=BvtMetricsCommon()
print "BVT BvtBlogsFetchMetricsSnapshot ... starting."

#-------------------------------------------------
# Main  - just execute the BvtBlogsFetchMetricsSnapshot test function
#-------------------------------------------------
print "BVT BvtBlogsFetchMetricsSnapshot ... calling BvtBlogsFetchMetricsSnapshot()"
