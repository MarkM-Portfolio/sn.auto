#  bvt_communities_fetch_metrics_snapshot.py
#
#  Jython Script to test Communities Metrics commands on IBM Communities Enterprise Application
#  (C) Copyright IBM Corporation, 2008
#
#  DESCRIPTION:
#  This script takes a snapshot of Communities metrics and writes it to the file:
#  communitiesMetricsSnapshot.txt.  The purpose of the snapshot file is to allow the 
...
#  communities contributes to the correct metrics values when processed by the test validation.
#
...
#Globals
UNIQUE_SCRIPT_ID = "bvt_communities_fetch_metrics_snapshot"
...
def BvtCommunitiesFetchMetricsSnapshot():
   print ""
   print "--------------------------------------------------------------------------------"
   print " BVT Test Script for Producing an Communities Metrics Snapshot at the time this script is invoked "
   ...
   print ""
   print "Fetching Communities Metrics Snapshot . . ."
   communitiesMetricsSnapshot = CommunitiesMetricsService.fetchMetrics()   
   print ""

   print ""
   print "Communities Metrics Snapshot Data . . ."
   bvtMetricsCommon.listAllMetrics(communitiesMetricsSnapshot)
   print ""
   
   print ""
   print "Writing Communities Metrics Snapshot Data to snapshot file: " + SNAPSHOTFILE + " . . ."
   bvtMetricsCommon.writeMetricsToFile(SNAPSHOTFILE, communitiesMetricsSnapshot, None)
   print ""
...
bvtMetricsCommon=BvtMetricsCommon()
print "BVT BvtCommunitiesFetchMetricsSnapshot ... starting."

#-------------------------------------------------
# Main  - just execute the BvtCommunitiesFetchMetricsSnapshot test function
#-------------------------------------------------
print "BVT BvtCommunitiesFetchMetricsSnapshot ... calling BvtCommunitiesFetchMetricsSnapshot()"
if DEBUG_SCRIPT != None:
   ...
   BvtCommunitiesFetchMetricsSnapshot()
   global fErrorFile
   fErrorFile.close()
   os.unlink(ERRORFILE)
else:	
