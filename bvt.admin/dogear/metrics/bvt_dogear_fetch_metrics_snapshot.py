#  bvt_dogear_fetch_metrics_snapshot.py
#
#  Jython Script to test some Dogear commands on IBM Dogear Enterprise Application
#  (C) Copyright IBM Corporation, 2008
#
#  DESCRIPTION:
#  This script takes a snapshot of Dogear metrics and writes it to the file:
#  dogearMetricsSnapshot.txt.  The purpose of the snapshot file is to allow the 
...
#Globals
UNIQUE_SCRIPT_ID = "bvt_dogear_fetch_metrics_snapshot"
...
def BvtDogearFetchMetricsSnapshot():
   print ""
   print "--------------------------------------------------------------------------------"
   print " BVT Test Script for Producing an Dogear Metrics Snapshot at the time this script is invoked "
   ...
   print ""
   print "Fetching Dogear Metrics Snapshot . . ."
   dogearMetricsSnapshot = DogearMetricsService.fetchMetrics()   
   print ""

   print ""
   print "Dogear Metrics Snapshot Data . . ."
   bvtMetricsCommon.listAllMetrics(dogearMetricsSnapshot)
   print ""
   
   print ""
   print "Writing Dogear Metrics Snapshot Data to snapshot file: " + SNAPSHOTFILE + " . . ."
   bvtMetricsCommon.writeMetricsToFile(SNAPSHOTFILE, dogearMetricsSnapshot, None)
   print ""
...
bvtMetricsCommon=BvtMetricsCommon()
print "BVT BvtDogearFetchMetricsSnapshot ... starting."

#-------------------------------------------------
# Main  - just execute the BvtDogearFetchMetricsSnapshot test function
#-------------------------------------------------
print "BVT BvtDogearFetchMetricsSnapshot ... calling BvtDogearFetchMetricsSnapshot()"
