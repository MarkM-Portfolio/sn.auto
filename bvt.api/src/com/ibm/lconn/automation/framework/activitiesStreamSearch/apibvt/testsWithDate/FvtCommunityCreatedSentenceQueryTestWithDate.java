...
public class FvtCommunityCreatedSentenceQueryTestWithDate extends ActivityStreamSearchTest {

	private static String searchString = "/@public/@all/@communities?query=";
	private static String filterWord = "First%20Manager";

	@Test
	public void fvtCommunityCreatedSentenceQueryTest() throws Exception {
		LOGGER.fine("ASS:fvtCommunityCreatedSentenceQueryTest");
