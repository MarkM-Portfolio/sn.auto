...
public class FvtMentionsWithFilterTestMySelfWithDate extends ActivityStreamSearchTest {
	...
	private void setProfileAdmin() throws Exception {
	...
	public void checkMentionsWithQuery() throws Exception {
		LOGGER.fine("ASS:FvtMentionsWithFilterTestMySelfWithDate: checkMentionsWithQuery");
		setProfileAdmin();
