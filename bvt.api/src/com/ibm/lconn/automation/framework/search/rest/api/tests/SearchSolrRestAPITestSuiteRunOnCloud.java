...
public class SearchSolrRestAPITestSuiteRunOnCloud {
	protected final static Logger LOGGER = LoggerFactory
			.getLogger(SearchSolrRestAPITestSuiteRunOnCloud.class.getName());

	@BeforeTest
	public static void setUp() throws Exception {
		LOGGER.debug("SearchSolrRestAPITestSuiteRunOnCloud setup");
		...
		Populator.populationForSolrOnly();

		new SearchAdminService().indexNowActivitiesOnCloud();
