...
public class SearchServiceScopeParameterTest extends SearchTest {
	...
	public void testsScopeParameterActivities() throws Exception {
		LOGGER.fine("Test SearchScopeParameterTest#testsScopeParameterActivities");
		SearchResponse searchResponse = prepareAndExecuteQuery(Scope.activities);
		Verifier.verifyEntriesScope(searchResponse, Scope.activities);
		Verifier.verifyEntriesComparedToPopulation(searchResponse, Scope.activities);
	}
	...
	@Test
	public void testsScopeParameterCommunitiesContent() throws Exception {
		LOGGER.fine("Test SearchScopeParameterTest#testsScopeParameterCommunitiesContent");
		SearchResponse searchResponse = prepareAndExecuteQuery(Scope.communities_content);
		Verifier.verifyEntriesScope(searchResponse, Scope.communities_content);
		Verifier.verifyEntriesComparedToPopulation(searchResponse, Scope.communities_content);
	}
	...
	public void testsScopeParameterWikis() throws Exception {
		LOGGER.fine("Test SearchScopeParameterTest#testsScopeParameterWikis");
		SearchResponse searchResponse = prepareAndExecuteQuery(Scope.wikis);
		Verifier.verifyEntriesScope(searchResponse, Scope.wikis);
		Verifier.verifyEntriesComparedToPopulation(searchResponse, Scope.wikis);
	}

	@Test
	public void testsScopeParameterFiles() throws Exception {
		LOGGER.fine("Test SearchScopeParameterTest#testsScopeParameterFiles");
