...
public class PeopleFinderAuthentications {
	...
	public void testBasicAuthentication() throws UnsupportedEncodingException {
		...
		ClientResponse response = peopleFinderService.typeAhead(
				PeopleFinderService.BASIC_AUTH_CONTEXT_PATH, request);
	 ...
	 * 108898
	 */
	public void testBasicAuthenticationLogoutAnonymous401()
		...
		ClientResponse response1 = peopleFinderService.typeAhead(
				PeopleFinderService.BASIC_AUTH_CONTEXT_PATH, request);
		Verifier.verifyResponseTypeAndStatusCode(ResponseType.CLIENT_ERROR,
				401, response1);
	}
	...
	public void testBasicAuthenticationWrongPassword()
		...
		restApiUser.logout();
		restApiUser.basicAuthenticationLogin(restApiUser.getProfData()
				.getUserName(), WRONG_PASSWORD);
		String query = restApiUser.getProfData().getUserName();
		PeopleFinderRequest request = new PeopleFinderRequest(query);
		ClientResponse response = peopleFinderService.typeAhead(
				PeopleFinderService.BASIC_AUTH_CONTEXT_PATH, request);
	...
	public void testAnonymousAuthentication()
		...
		PeopleFinderRequest request = new PeopleFinderRequest(query);
		ClientResponse response = peopleFinderService.typeAhead(
				PeopleFinderService.ANONYMOUS_AUTH_CONTEXT_PATH, request);
		Verifier.verifyResponseTypeAndStatusCode(ResponseType.SUCCESS, 200,
				response);
	}
	 ...
	 * 108898
	 */
	public void testFormBaseAuthentication()
			throws UnsupportedEncodingException {
		...
		PeopleFinderRequest request = new PeopleFinderRequest(query);
		ClientResponse response = peopleFinderService.typeAhead(
				PeopleFinderService.FORM_BASE_AUTH_CONTEXT_PATH, request);
		Verifier.verifyResponseTypeAndStatusCode(ResponseType.SUCCESS, 200,
				response);
	}
	 ...
	 * 108898
	 */
	public void testFormBaseAuthenticationLogoutAnonimous203()
			throws UnsupportedEncodingException {
		LOGGER.fine("Test PeopleFinderAuthentications#testFormBaseAuthentication");
		restApiUser.logout();
		...
		ClientResponse response1 = peopleFinderService.typeAhead(
				PeopleFinderService.FORM_BASE_AUTH_CONTEXT_PATH, request);
		Verifier.verifyResponseTypeAndStatusCode(ResponseType.REDIRECTION, 302,
				response1);
	}
	 ...
	 * 108898
	 */
	public void testFormBaseAuthenticationWrongPassword()
			throws UnsupportedEncodingException {
		LOGGER.fine("Test PeopleFinderAuthentications#testFormBaseAuthenticationWrongPassword");
		restApiUser.logout();

		restApiUser.formBaseAuthenticationLogin(restApiUser.getProfData()
				.getUserName(), WRONG_PASSWORD);
		String query = restApiUser.getProfData().getUserName();
		PeopleFinderRequest request = new PeopleFinderRequest(query);
		ClientResponse response = peopleFinderService.typeAhead(
