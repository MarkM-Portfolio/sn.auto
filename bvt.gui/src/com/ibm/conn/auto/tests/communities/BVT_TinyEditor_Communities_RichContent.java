...
public class BVT_TinyEditor_Communities_RichContent extends SetUpMethods2 {
	...
	/**
	 * <ul>
	 * <li><B>Info:</B>Create community with API and validate tiny editor features on Rich context</li>
	 * <li><B>Step:</B>Navigate to community dash-board page</li>
	 * <li><B>Step:</B>Click on add content of Rich Content text widget</li>
	...
	public void verifyRichContentTinyEditorParagraphFunctionality() throws Exception {
		...
		BaseCommunity community = new BaseCommunity.Builder(testName + Helper.genDateBasedRandVal())
				...
				.tinyEditorFunctionalitytoRun("verifyParaInTinyEditor,verifyIndentsInTinyEditor,"
						...
						+ "verifyUploadImageFromDiskInTinyEditor")
				.isRichContent(true)
				.build();
		...
		String ComText = ui.getRichContentText().trim();
	 ...
	 */
	@Test(groups = { "TinyEditor" })
	public void verifyRichContentTinyEditorFontAttributeFunctionality() throws Exception {
	 ...
	 */
	@Test(groups = { "TinyEditor" })
	public void verifyRichContentTinyEditorLineBulletTableImageIFrameFunctionality() throws Exception {
		...
		BaseCommunity community = new BaseCommunity.Builder(testName + Helper.genDateBasedRandVal())
				.tags(Data.getData().commonTag + Helper.genDateBasedRandVal())
				.commHandle(Data.getData().commonHandle + Helper.genDateBasedRandVal()).access(Access.PUBLIC)
				.description("this is Test description with url and Browse" + testName).addMember(member)
				.tinyEditorFunctionalitytoRun("verifyHorizontalLineInTinyEditor,verifyBulletsAndNumbersInTinyEditor,verifyBlockQuoteInTinyEditor,"+
						"verifyInsertiFrameInTinyEditor,verifyLinkImageInTinyEditor,verifyRowsCoulmnOfTableInTinyEditor")
				.isRichContent(true)
				.build();
	 ...
	 */
		...
		/*verifyEmotionsInTinyEditor : removed this test case because functionality is no
		more available in rich content */
	@Test(groups = { "TinyEditor" })
	public void verifyRichContentTinyEditorFindReplaceSpellcheckUndoRedoSpecialCharFunctionality() throws Exception {
	 ...
	 */
	@Test(groups = { "TinyEditor" })
	public void verifyRichContentTinyEditorInsertLink() throws Exception {
		...
		BaseCommunity community = new BaseCommunity.Builder(testName + Helper.genDateBasedRandVal())
				.tags(Data.getData().commonTag + Helper.genDateBasedRandVal())
				.commHandle(Data.getData().commonHandle + Helper.genDateBasedRandVal()).access(Access.PUBLIC)
				.description("this is Test description for testcase RichCon" + testName).addMember(member)
	...
	/**
	 * <ul>
	 * <li><B>Info:</B>Create community with API and validate edit description of rich text on dashboard</li>
	 * <li><B>Step:</B>Navigate to community dash-board page</li>
	 * <li><B>Step:</B>Click on add content of Rich Content text widget and save it</li>
	 * <li><B>Step:</B>Select edit description and edit the rich content description</li>
	 * <li><B>Step:</B>Save the description</li>
	 * <li><B>Verify:</B>Verify edited description on rich content widget
	 * <li><B>Step:</B>Delete community</li>
	 * </ul>
	 */
	@Test(groups = { "TinyEditor" })
	public void verifyRichContentTinyEditorEditFunctionality() throws Exception {
	 ...
	 * <li><B>Step:</B>Save community</li>
	 * <li></B>Verify link Images is added in Rich Content Widget of Community</li>
 	 * <li></B>Verify link Images preview and image download in Rich Content Widget of Community</li>
	...
	public void verifyLinkToConnectionsFilesFromFilesInTinyEditor() throws Exception {
		...
		tui.ImageDownload(CommunitiesUIConstants.richContentDescription);
		fui.verifyFileDownloaded(file.getName());
		
		log.info("INFO: Validate image preview  from Rich content");
		logger.strongStep("Validate image preview from Rich content");
		
		ui.verifyInsertedImageLinkFromRichContent(file.getName());
	...
	public void verifyLinkToConnectionsFilesFromThisCommunityInTinyEditor() throws Exception {
		...
		BaseCommunity community = new BaseCommunity.Builder(testName + Helper.genDateBasedRandVal())
				.tags(Data.getData().commonTag + Helper.genDateBasedRandVal())
				.commHandle(Data.getData().commonHandle + Helper.genDateBasedRandVal()).access(Access.PUBLIC)
				.description("this is Test description for Community RichCon" + testName).addMember(member)
				.tinyEditorFunctionalitytoRun("verifyLinkToConnectionsFilesInTinyEditor")
				.isRichContent(true)
				.build();
