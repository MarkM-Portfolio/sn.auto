...
public class PersonaFiles_Sync extends SetUpMethods2 {
	private FilesUI ui;
	private TestConfigCustom cfg;
	private User testUser, adminUser;
	// private FilesDragDropUI dUI;
	...
	@Test(groups = { "unit","foldersync" })
	public void testShowPublicFilesByAnonymouseLogIn() throws Exception {
