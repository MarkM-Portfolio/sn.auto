...
public class FVT_IdeationBlogs_InlineCommentEvents_ModeratedCommunity extends SetUpMethods2 {
	...
	/**
	* test_IdeationBlogs_ModeratedCommunity_InlineComments() 
	*<ul>
	...
	*/
	...
	public void test_IdeationBlogs_ModeratedCommunity_InlineComments() {
		...
		BlogPost communityIdea = CommunityBlogEvents.createIdea(moderatedCommunity, baseBlogPost, testUser1, communityBlogsAPIUser1);
		...
		String commentOnIdeaEvent = CommunityBlogNewsStories.getCommentOnYourIdeaNewsStory_User(ui, baseBlogPost.getTitle(), baseModeratedCommunity.getName(), testUser2.getDisplayName());
		...
		// Create the news story to be verified
		String votedForIdeaEvent = CommunityBlogNewsStories.getVotedForYourIdeaNewsStory_User(ui, baseBlogPost.getTitle(), baseModeratedCommunity.getName(), testUser2.getDisplayName());
