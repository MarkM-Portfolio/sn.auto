...
public class FVT_IdeationBlogs_InlineCommentEvents_RestrictedCommunity extends SetUpMethods2 {
	...
	public void setUpClass() {
		...
		// User 2 will now log into the community - critical step for API calls to work correctly when run against G2, G3 etc.
		...
		// Close the browser window instance
	...
	/**
	* test_IdeationBlogs_RestrictedCommunity_InlineComments() 
	*<ul>
	...
	*/
	...
	public void test_IdeationBlogs_RestrictedCommunity_InlineComments() {
		...
		BlogPost communityIdea = CommunityBlogEvents.createIdea(restrictedCommunity, baseBlogPost, testUser1, communityBlogsAPIUser1);
		
		// Log in as User 2 and navigate to the idea - critical step for the post comments API methods to work when run against G2, G3 etc.
		CommunityBlogEvents.loginAndNavigateToIdea(ui, uiCo, restrictedCommunity, baseRestrictedCommunity, baseBlogPost, testUser2, communitiesAPIUser2, false);
		...
		// Close the browser window instance - this is a critical step to ensure the following login attempt works consistently on G2, G3 etc.
		UIEvents.closeCurrentBrowserWindow(ui);
		...
		String commentOnIdeaEvent = CommunityBlogNewsStories.getCommentOnYourIdeaNewsStory_User(ui, baseBlogPost.getTitle(), baseRestrictedCommunity.getName(), testUser2.getDisplayName());
		...
		// Create the news story to be verified
		String votedForIdeaEvent = CommunityBlogNewsStories.getVotedForYourIdeaNewsStory_User(ui, baseBlogPost.getTitle(), baseRestrictedCommunity.getName(), testUser2.getDisplayName());
