...
public class FVT_Discover_ModComIdeaBlog_Comments extends SetUpMethodsFVT {
	...
	/**
	 * <ul>
	 * <li><B>Name:</B> ModerateComIdeaComment()</li>
	 * <li><B>How:</B> Use the API to create moderate community owned by testUser1, add an idea blog, an Idea and a comment to the idea</li>
	 * <li><B>Step:</B> testUser1 log in to Communities</li>
	 * <li><B>Step:</B> testUser1 open a community you own with moderated access</li>
	 ...
	 * <li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/AA76BE2C8F586ACA852578760079EAA9">TTT - DISC - IDEABLOGS - 00040 - IDEABLOG.COMMENT.CREATED - MODERATED COMMUNITY IDEABLOG</a></li>	
	 * @author Naomi Pakenham
	 */	
	@Test(groups = {"fvtonprem", "fvtcloud"}, priority = 1)
	public void ModerateComIdeaComment() {
	...
	/**
	* <ul>
	* <li><B>Name:</B> ModerateComIdeaEditComment()()</li>
	...
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/9F645487115009A785257B500047AC28">TTT - DISC - IDEABLOGS - 00111 - IDEABLOG.COMMENT.EDITED - MODERATED COMMUNITY IDEABLOG</a></li>
	*</ul>	
	* @author Naomi Pakenham
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"}, priority = 2)
	public void ModerateComIdeaEditComment() {
	...
	/**
	*<ul>
	*<li><B>Name: test_deleteCommentToIdea_ModerateCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 log in to Communities</B></li>
	*<li><B>Step: testUser 1 creates a new community with Moderate access</B></li>
	*<li><B>Step: testUser 1 add the Ideation Blog widget and create a new ideation blog and idea</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/088F49BF479C68258525751B0060FA97/7FCD6644C168FD2C85257B500046FF3D">TTT - DISC - IDEABLOGS - 00101 - IDEABLOG.COMMENT.DELETED - MODERATED COMMUNITY IDEABLOG</a></li>
	*</ul>
	* @author Patrick Doherty
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"}, priority = 3)
	public void test_deleteCommentToIdea_ModerateCommunity() {
	...
	/**
	 * <ul>
	 * <li><B>Name:</B> ModerateComIdeaCommentLike()</li>
	 * <li><B>Step:</B> testUser1 log in to Communities</li>
	 * <li><B>Step:</B> testUser1 open a community with moderated access that you have owner access to</li>
	 * <li><B>Step:</B> testUser1 add the ideablogs widget within this community</li>
	 ...
	 * <li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/99506C3F9DC1828B852578760079EAB7">TTT - DISC - IDEABLOGS - 00070 - IDEABLOG.COMMENT.RECOMMENDED - MODERATED COMMUNITY IDEABLOG</a></li>	
	 * </ul>
	 * @author Naomi Pakenham
	 */
	@Test(groups = {"fvtonprem", "fvtcloud"}, priority = 4)
	public void ModerateComIdeaCommentLike() {
	...
	private void createBlogPostIfRequired() {
		if(blogPost == null) {
			...
			blogPost = CommunityBlogEvents.createIdea(moderatedCommunity, baseBlogPost, testUser1, communityBlogsAPIUser1);
		}
	}
