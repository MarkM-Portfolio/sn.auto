...
public class FVT_Discover_PublicCommunityBlog_Comments extends SetUpMethodsFVT {
	...
	public void setUpClass() {
		...
		// User 1 create a public community with Blogs widget added to be used in all tests
	...
	/**
	 * <ul>
	 * <li><B>Name:</B> PublicCommunityBlogComment()</li>
	 * <li><B>Purpose:</B>Verify the story shows in the correct Discover views</li>
	 * <li><B>Step:</B> testUser1 log in to Communities</li> 
	 * <li><B>Step:</B> testUser1 open a public community that has an existing blog entry</li> 
	 ...
	 * <li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/13500D552F555ABB852578760079E750">TTT - DISC - BLOGS - 00040 - BLOG.COMMENT.CREATED - PUBLIC COMMUNITY BLOG</a></li>
	 * </ul>
	 * @author Naomi Pakenham
	 */
	@Test(groups = {"fvtonprem", "fvtcloud"}, priority = 1)
	public void PublicCommunityBlogComment() {
	...
	/**
	* test_PublicCommunityBlogCommentRecommend() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: User 1 log into Communities</B></li>
	*<li><B>Step: User 1 open a public community that has a blog with an existing blog entry and comment</B></li>
	*<li><b>Step: User 1 recommend this comment</b></li>
	...
	*<li><B>Verify: Verify that the news story for blog.comment.recommended is seen</B></li>
	* <li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/2F65DFAFD216C16E852578760079E75C">TTT - DISC - BLOGS - 00070 - BLOG.COMMENT.RECOMMENDED - PUBLIC COMMUNITY BLOG</a></li>
	* @author Naomi Pakenham 
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"}, priority = 2)
	public void test_PublicCommunityBlogCommentRecommend() {
	...
	/**
	*<ul>
	*<li><B>Name: test_editCommentToEntry_PublicCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/088F49BF479C68258525751B0060FA97/50A3B0C7A5D425ED85257B50003A9B30">TTT - DISC - BLOGS - 00112 - BLOG.COMMENT.EDITED - PUBLIC COMMUNITY BLOG</a></li>
	*</ul>
	* @author Patrick Doherty
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"}, priority = 3)
	public void test_editCommentToEntry_PublicCommunity() {
	...
	/**
	*<ul>
	*<li><B>Name: test_deleteCommentToEntry_PublicCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 log in to Communities</B></li>
	*<li><B>Step: testUser 1 creates a new community with public access</B></li>
	*<li><B>Step: testUser 1 add the Blogs widget and create a new blog and blog entry</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/088F49BF479C68258525751B0060FA97/C10B04B6C7E7953085257B500037939A">TTT - DISC - BLOGS - 00102 - BLOG.COMMENT.DELETED - PUBLIC COMMUNITY BLOG</a></li>
	*</ul>
	* @author Patrick Doherty
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"}, priority = 4)
	public void test_deleteCommentToEntry_PublicCommunity() {
		...
		for(String filter : TEST_FILTERS) {
			...
			HomepageValid.verifyItemsInAS(ui, driver, new String[]{commentOnEntryEvent, baseBlogPost.getContent(), blogCommentUser1.getContent()}, filter, true);
		...
		for(String filter : TEST_FILTERS) {
			...
			HomepageValid.verifyItemsInAS(ui, driver, new String[]{commentOnEntryEvent, twoCommentsOnEntryEvent, blogCommentUser1.getContent(), blogCommentUser2.getContent()}, null, false);
		}
		ui.endTest();
	}
	...
	private void createBlogPostIfRequired() {
		if(blogPost == null) {
			...
			blogPost = CommunityBlogEvents.createBlogPost(testUser1, communityBlogsAPIUser1, baseBlogPost, publicCommunity);
		}
	}
