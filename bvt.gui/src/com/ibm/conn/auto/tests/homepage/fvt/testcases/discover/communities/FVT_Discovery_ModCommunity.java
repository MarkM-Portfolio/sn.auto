...
public class FVT_Discovery_ModCommunity extends SetUpMethodsFVT {
	...
	/**
	 * <ul>
	 * <li><B>Name:</B> test_createModeratedCommunity()</li>
	 ...
	 * <li><B>Verify: Verify that the news story for community.created is seen</B></li>
	 * <li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/904A54421A7FE148852578760079E763">TTT - DISC - COMMUNITIES - 00010 - COMMUNITY.CREATED - MODERATED COMMUNITY</a></li>	
	 * @author Naomi Pakenham
	 */	
	@Test(groups = {"fvtonprem", "fvtcloud"}, priority = 1)
	public void test_createModeratedCommunity() {
		...
		HomepageValid.verifyItemsInASUsingMultipleFilters(ui, driver, new String[]{commCreated, baseCommunity.getDescription()}, TEST_FILTERS_COMMUNITY, true);
	...
	/**
	 * <ul>
	 * <li><B>Name:</B> test_createModeratedCommunityBookmark()</li>
	 * <li><B>Step: User 1 log into Communities</B></li>
	 * <li><B>Step: User 1 open a community with moderated access that you have owner access to</B></li>
	 ...
	 * <li><B>Step: User 2 go to Home \ Activity Stream \ Discover</B></li>
	 * <li><B>Step: User 2 filter by Communities</B></li>
	 * <li><B>Verify: Verify that the news story for community.bookmark.created is seen</B></li>
	 * <li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/83C1109538FAE01C852578760079E766">TTT - DISC - COMMUNITIES - 00020 - COMMUNITY.BOOKMARK.CREATED - MODERATED COMMUNITY</a></li>	
	 * @author Naomi Pakenham
	 */
	@Test(groups = {"fvtonprem", "fvtcloud"}, priority = 2)
	public void test_createModeratedCommunityBookmark() {
		...
		if(isOnPremise){
			HomepageValid.verifyItemsInASUsingMultipleFilters(ui, driver, new String[]{bookmarkCreated, baseDogear.getDescription()}, TEST_FILTERS_COMMUNITY_BOOKMARK, true);
		} else {
			HomepageValid.verifyItemsInASUsingMultipleFilters(ui, driver, new String[]{bookmarkCreated, baseDogear.getDescription()}, TEST_FILTERS_COMMUNITY, true);
		}
		ui.endTest();	
	}
	...
	/**
	 * <ul>
	 * <li><B>Name:</B> test_BookmarkEdit_ModeratedCommunity()</li>
	 * <li><B>Step: User 1 log into Communities</B></li>
	 * <li><B>Step: User 1 open a community with moderated access that you have owner access to</B></li>
	 ...
	 * <li><B>Step: User 2 go to Home \ Activity Stream \ Discover</B></li>
	 * <li><B>Step: User 2 filter by Communities</B></li>
	 * <li><B>Verify: Verify that the news story for community.bookmark.updated is seen</B></li>
	 * <li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/B9E10CC569FEE3D8852579BC00593A1E">TTT - DISC - COMMUNITIES - 00050 - COMMUNITY.BOOKMARK.UPDATED - MODERATED COMMUNITY</a></li>	
	 * @author Naomi Pakenham
	 */
	@Test(groups = {"fvtonprem", "fvtcloud"}, priority = 2)
	public void test_BookmarkEdit_ModeratedCommunity() {
		...
		for(String filter: THIS_TEST_FILTERS) {
			// Verify that the update bookmark event and edited description are displayed in all views
			HomepageValid.verifyItemsInAS(ui, driver, new String[]{bookmarkUpdated, editedDescription}, filter, true);
			
			// Verify that the original description is NOT displayed in any of the views
			HomepageValid.verifyItemsInAS(ui, driver, new String[]{baseDogear.getDescription()}, null, false);
		}
		ui.endTest();
	}			
}