...
public class FVT_Discover_PublicFileLike_FileOverlay extends SetUpMethodsFVT {
	...
	*/
	...
	public void fileLike_FileOverlay() {
		...
		for(String filter : TEST_FILTERS) {
			...
			// Open the file details overlay for the like / recommend file event in the current view
