 ...
 */
public class FVT_Discover_PublicFileUpdate_FileOverlay extends SetUpMethodsFVT {
	...
	/**
	* fileUpdate_FileOverlay() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: User 1 uploads a public folder</B></li>
	*<li><B>Step: User 1 updates the file</B></li>
	...
	*/
	...
	public void fileUpdate_FileOverlay() {
		
		ui.startTest();
		
		// User 1 will now update the version of the public file
		...
		for(String filter : TEST_FILTERS) {
			...
			// Open the file details overlay for the update file event in the current view
