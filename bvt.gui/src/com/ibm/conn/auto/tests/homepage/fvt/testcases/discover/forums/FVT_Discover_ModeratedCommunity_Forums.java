...
public class FVT_Discover_ModeratedCommunity_Forums extends SetUpMethodsFVT {
	...
	public void setUpClass() {
		...
		// Creating the moderated community with all setup steps completed.
	...
	/**
	 *<ul>
	 *<li><B>Title:</B>atest_CreateForum_ModeratedCommunity()</li>
	 ...
	 *<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/17180B278F00AD4B852578760079E804">TTT - DISC - FORUMS - 00000 - FORUM.CREATED - MODERATED COMMUNITY</a></li>
	 *</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void atest_CreateForum_ModeratedCommunity() {
	...
	/**
	 *<ul>
	 *<li><B>Title:</B>test_CreateForumTopic_ModeratedCommunity()</li>
	 *<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	 *<li><B>Step: testUser 1 log in to Communities</B></li>
	 *<li><B>Step: testUser 1 open a community with Moderate access that you have owner access to</B></li>
	 *<li><B>Step: testUser 1 add the forums widget within this community if not already present</B></li>
	 ...
	 *<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/5B274C1529B19746852578760079E78B">TTT - DISC - FORUMS - 00010 - FORUM.TOPIC.CREATED - MODERATED COMMUNITY</a></li>
	 *</ul> 
	*/
	@Test(groups ={"fvtonprem", "fvtcloud"})
	public void test_CreateForumTopic_ModeratedCommunity() {

		String testName = ui.startTest();

		// Create the forum topic
		BaseForumTopic baseTopic = ForumBaseBuilder.buildCommunityBaseForumTopic(testName + Helper.genStrongRand(), baseCommunity);
		ForumTopic forumTopic = CommunityForumEvents.createForumTopic(testUser1, communitiesAPIUser1, moderatedCommunity, baseTopic);
	 ...
	 *<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/4CE77BDCA5DD63FB852578760079E790">TTT - DISC - FORUMS - 00020 - FORUM.RESPONSE.CREATED - MODERATED COMMUNITY</a></li>
	 *</ul> 
	*/
	@Test(groups ={"fvtonprem", "fvtcloud"})
	public void test_CreateForumTopicReply_ModeratedCommunity() {
		...
		BaseForumTopic baseTopic = ForumBaseBuilder.buildCommunityBaseForumTopic(testName + Helper.genStrongRand(), baseCommunity);
		ForumTopic forumTopic = CommunityForumEvents.createForumTopicAndAddReply(testUser1, communitiesAPIUser1, moderatedCommunity, baseTopic, forumsAPIUser1, topicReply);
	...
	/**
	 *<ul>
	 *<li><B>Title:</B>test_UpdateForumTopic_ModeratedCommunity()</li>
	 *<li><B>Step: testUser 1 log in to Communities</B></li>
	 *<li><B>Step: testUser 1 open a community with Moderate access that you have owner access to</B></li>
	 *<li><B>Step: testUser 1 add the forums widget within this community if not already present</B></li>
	 ...
	 *<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/75F467A2CE95C6DD852579BC005B6095">TTT - DISC - FORUMS - 00015 - FORUM.TOPIC.UPDATED - MODERATED COMMUNITY</a></li>
	 *</ul>
	 */
	@Test(groups ={"fvtonprem", "fvtcloud"})
	public void test_UpdateForumTopic_ModeratedCommunity() {
		...
		BaseForumTopic baseTopic = ForumBaseBuilder.buildCommunityBaseForumTopic(testName + Helper.genStrongRand(), baseCommunity);
		ForumTopic forumTopic = CommunityForumEvents.createForumTopicAndEditDescription(testUser1, communitiesAPIUser1, moderatedCommunity, baseTopic, forumsAPIUser1, editedDescription);
	...
	/**
	 *<ul>
	 *<li><B>Title:</B>test_UpdateForumTopicReply_ModeratedCommunity()</li>
	 *<li><B>Step: testUser 1 log in to Communities</B></li>
	 *<li><B>Step: testUser 1 open a community with Moderate access that you have owner access to</B></li>
	 *<li><B>Step: testUser 1 add the forums widget within this community if not already present</B></li>
	 ...
	 *<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/4FE6A10FCF24D08B852579BC005CD1BE">TTT - DISC - FORUMS - 00025 - FORUM.TOPIC.REPLY.UPDATED - MODERATED COMMUNITY</a></li>
	 *</ul>
	 */
	@Test(groups ={"fvtonprem", "fvtcloud"})
	public void test_UpdateForumTopicReply_ModeratedCommunity() {
		...
		ForumTopic forumTopic = CommunityForumEvents.createForumTopicAndAddReplyAndEditReply(testUser1, communitiesAPIUser1, moderatedCommunity, baseForumTopic, forumsAPIUser1, topicReply, editedTopicReply);
	...
	/**
	 * <ul>
	 * <li><B>Title:</B>test_LikeTopic__ModeratedCommunity()</li>
	 *<li><B>Step: testUser 1 log in to Communities</B></li>
	 *<li><B>Step: testUser 1 open a community with Moderate access that you have owner access to</B></li>
	 *<li><B>Step: testUser 1 add the forums widget within this community if not already present</B></li>
	 ...
	 *<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/6E30A0B93FE9108E85257AC4004F3C2B">TTT - DISC - FORUMS - 00030 - FORUM.TOPIC.RECOMMENDED - MODERATE COMMUNITY FORUM</a></li>
	 *</ul> 
	 */
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void test_LikeTopic_ModeratedCommunity() {

		String testName = ui.startTest();

		// User 1 will now create a forum topic and like the topic
		BaseForumTopic baseTopic = ForumBaseBuilder.buildCommunityBaseForumTopic(testName + Helper.genStrongRand(), baseCommunity);
		ForumTopic forumTopic = CommunityForumEvents.createForumTopicAndLikeTopic(testUser1, communitiesAPIUser1, moderatedCommunity, baseTopic, forumsAPIUser1);
	...
	/**
	 * <ul>
	 * <li><B>Title:</B>test_LikeTopicReply_ModeratedCommunity()</li>
	 *<li><B>Step: testUser 1 log in to Communities</B></li>
	 *<li><B>Step: testUser 1 open a community with Moderate access that you have owner access to</B></li>
	 *<li><B>Step: testUser 1 add the forums widget within this community if not already present</B></li>
	 ...
	 * <li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/341384CEC6E3CF6985257AC40051D2EE">TTT - DISC - FORUMS - 00035 - FORUM.TOPIC.REPLY.RECOMMENDED - MODERATE COMMUNITY FORUM</a></li>
	 *</ul> 
	 */
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void test_LikeTopicReply_ModeratedCommunity() {
		...
		String topicReply = Data.getData().commonComment + Helper.genStrongRand();
		BaseForumTopic baseTopic = ForumBaseBuilder.buildCommunityBaseForumTopic(testName + Helper.genStrongRand(), baseCommunity);
		ForumTopic forumTopic = CommunityForumEvents.createForumTopicAndAddReplyAndLikeReply(testUser1, communitiesAPIUser1, moderatedCommunity, baseTopic, forumsAPIUser1, topicReply);
