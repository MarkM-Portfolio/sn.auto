...
public class FVT_ImFollowing_CommunityFolder_ModerateCommunity extends SetUpMethodsFVT {
	...
	public void setUpClass(){
		...
		moderatedCommunity = CommunityEvents.createNewCommunityWithOneFollower(baseCommunity, testUser2, communitiesAPIUser2, testUser1, communitiesAPIUser1);
		...
		communityFile1 = CommunityFileEvents.addFile(moderatedCommunity, baseFile1, testUser1, filesAPIUser1);
		...
		communityFile2 = CommunityFileEvents.addFile(moderatedCommunity, baseFile2, testUser1, filesAPIUser1);
	}
	...
	/**
	*<ul>
	*<li><B>Name: test_follow Community_Community Folder Created_ModerateCommunity()</B></li>
	...
	*<li><B>Step: testUser 2 follow the Moderate community</B></li>
	...
	*<li><B>Verify: Verify the community folder created event is NOT appears in the AS</B></li>
	* <li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/1D2CD8B6A687B9C285257BD40038D2E9">TTT -AS - Follow Community - 00241 - Community Folder Created - Moderate Community</a></li>
	* @author Srinivas Vechha
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void test_foldercreation_ModerateCommunity() {
		...
		CommunityFileEvents.addFolder(moderatedCommunity, baseFolder, testUser1, filesAPIUser1);
	...
	/**
	*<ul>
	*<li><B>Name: test_communityfollow_Community Folder File Added Created_ModerateCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 Log in to Communities</B></li>
	*<li><B>Step: testUser 1 start a Moderate community</B></li>
	*<li><B>Step: testUser 2 who is follow the Moderate community</B></li>
	...
	* <li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/47D2F5042C112D7685257BD40038D2EC">TTT - AS - Follow Community - 00251 - Community Folder File Added - Moderate Community</a></li>
	* @author Srinivas Vechha
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void test_fileaddtofolder_ModerateCommunity() {
	...
	/**
	*<ul>
	*<li><B>Name: test_FollowCommunity_Community Folder File Removed Created_ModerateCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 Log in to Communities</B></li>
	*<li><B>Step: testUser 1 start a Moderate community</B></li>
	*<li><B>Step: testUser 2 who is follow the Moderate community</B></li>
	...
	*<li><B>Step: testUser 2 go to Homepage / Updates / I'm Following / All, Communities & People</B></li>
	*<li><B>Verify: Verify the community folder file added event has been moved from the stream</B></li>
	* <li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/95F3EE5C4D8F508085257BD30048D77A">TTT -AS - Follow Community - 00256 - Community Folder File Removed - Moderate Community</a></li>
	* @author Srinivas Vechha
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void test_communityfolderfileremoved_ModerateCommunity(){
