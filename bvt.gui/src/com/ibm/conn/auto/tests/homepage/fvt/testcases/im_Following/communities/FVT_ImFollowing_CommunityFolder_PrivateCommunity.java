...
public class FVT_ImFollowing_CommunityFolder_PrivateCommunity extends SetUpMethodsFVT {
	...
	public void setUpClass(){
		...
		communityFile1 = CommunityFileEvents.addFile(restrictedCommunity, baseFile1, testUser1, filesAPIUser1);
		...
		communityFile2 = CommunityFileEvents.addFile(restrictedCommunity, baseFile2, testUser1, filesAPIUser1);
	}
	...
	/**
	*<ul>
	*<li><B>Name: test_follow Community_Community Folder Created_PrivateCommunity()</B></li>
	...
	*<li><B>Step: testUser 2 follow the Private community</B></li>
	...
	* <li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/E00DE5A2D1FE420985257BD40038D2EA">TTT - AS - Follow Community - 00242 - Community Folder Created - Private Community</a></li>
	* @author Srinivas Vechha
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void test_foldercreation_PrivateCommunity(){
		...
		CommunityFileEvents.addFolder(restrictedCommunity, baseFolder, testUser1, filesAPIUser1);
	...
	/**
	*<ul>
	*<li><B>Name: test_communityfollow_Community Folder File Added Created_PrivateCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 Log in to Communities</B></li>
	*<li><B>Step: testUser 1 start a private community and add User 2 as a member</B></li>
	*<li><B>Step: testUser 2 who is follow the Private community</B></li>
	*<li><B>Step: testUser 1 add a file to the folder in the community</B></li>
	*<li><B>Step: testUser 2 go to Homepage / Updates / I'm Following / All & Communities </B></li>
	*<li><B>Verify: Verify the community folder file uploaded event appears in the AS</B></li>
	* <li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/DDBF630AE2577FFD85257BD40038D2ED">TTT - AS - Follow Community - 00252 - Community Folder File Added - Private Community</a></li>
	* @author Srinivas Vechha
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void test_fileaddtofolder_PrivateCommunity(){
	...
	/**
	*<ul>
	*<li><B>Name: test_FollowCommunity_Community Folder File Removed Created_PrivateCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 Log in to Communities</B></li>
	*<li><B>Step: testUser 1 start a private community and add User 2 as a member</B></li>
	*<li><B>Step: testUser 2 who is follow the Private community</B></li>
	...
	* <li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/5F904B19858977B685257BD30048D77B">TTT -AS - Follow Community - 00257 - Community Folder File Removed - Private Community</a></li>
	* @author Srinivas Vechha
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void test_communityfolderfileremoved_PrivateCommunity(){
