...
public class FVT_ImFollowing_ModCommunities extends SetUpMethodsFVT {
	...
	/**
	 * <ul>
	 * <li><B>Name:</B> test_Create_moderateCommunity()</li>
	 ...
	 * <li><B>Verify: Verify that the news story for community.created is seen in the Communities view</B></li>
	 * <li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/B6929F5CBE54B565852578F700421990">TTT - AS - FOLLOW - COMMUNITY - 00012 - community.created - MODERATE COMMUNITY</a></li>
	 * @author Hugh Caren
	 */	
	@Test (groups ={"fvtonprem", "fvtcloud"}, priority = 1)
	public void test_Create_moderateCommunity() {
		...
		HomepageValid.verifyItemsInASUsingMultipleFilters(ui, driver, new String[]{createCommunityEvent, baseCommunity.getDescription()}, TEST_FILTERS_COMMUNITIES, true);
	...
	/**
	 * <ul>
	 * <li><B>Name:</B> test_AddBookmark_moderateCommunity()</li>
	 ...
	 * <li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/AB9226BE55A33FDB852578F7004A32A4">TTT - AS - FOLLOW - COMMUNITY - 00032 - community.bookmark.created - MODERATE COMMUNITY</a></li>
	 * @author Hugh Caren
	 */	
	@Test (groups ={"fvtonprem", "fvtcloud"}, priority = 2)
	public void test_AddBookmark_moderateCommunity() {
		...
		CommunityBookmarkEvents.createBookmark(moderatedCommunity, baseBookmark, testUser1, communitiesAPIUser1);
	...
	/**
	 * <ul>
	 * <li><B>Name:</B> test_BookmarkEdit_moderateCommunity()</li>
	 * <li><B>Step: Log in to Communities</B></li>
	 * <li><B>Step: Open a community with moderate access that you own</B></li>
	 ...
	 * <li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/672CCBEB4A897B17852579BB005DEE90">TTT - AS - FOLLOW - COMMUNITY - 00135 - community.bookmark.updated - MODERATE COMMUNITY (NEG SC NOV)</a></li>
	 * @author Hugh Caren
	 */	
	@Test (groups ={"fvtonprem", "fvtcloud"}, priority = 2)
	public void test_BookmarkEdit_moderateCommunity() {
		...
		CommunityBookmarkEvents.createBookmarkAndEditDescription(moderatedCommunity, baseBookmark, testUser1, communitiesAPIUser1, editedDescription);
