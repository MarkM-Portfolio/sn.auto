...
public class FVT_ImFollowing_PublicCommunities extends SetUpMethodsFVT {
	...
	/**
	 * <ul>
	 * <li><B>Name:</B> test_Create_PublicCommunity()</li>
	 ...
	 * <li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/58907DF9F5815CE4852578F7004156BB">TTT - AS - FOLLOW - COMMUNITY - 00011 - community.created - PUBLIC COMMUNITY</a></li>
	 * @author Hugh Caren
	 */	
	@Test (groups ={"fvtonprem", "fvtcloud"}, priority = 1)
	public void test_Create_PublicCommunity() {
	...
	/**
	 * <ul>
	 * <li><B>Name:</B> test_AddBookmark_PublicCommunity()</li>
	 ...
	 * <li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/D86425A1C86D86AE852578F700499BE8">TTT - AS - FOLLOW - COMMUNITY - 00031 - community.bookmark.created - PUBLIC COMMUNITY</a></li>
	 * @author Hugh Caren
	 */	
	@Test (groups ={"fvtonprem", "fvtcloud"}, priority = 2)
	public void test_AddBookmark_PublicCommunity() {
	 ...
	 * <li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/2A0E2E817E22CB50852579BB005DA643">TTT - AS - FOLLOW - COMMUNITY - 00134 - community.bookmark.updated - PUBLIC COMMUNITY (NEG SC NOV)</a></li>
	 * @author Hugh Caren
	 */	
	@Test (groups ={"fvtonprem", "fvtcloud"}, priority = 2)
	public void test_BookmarkEdit_PublicCommunity() {
		...
		CommunityBookmarkEvents.createBookmarkAndEditDescription(publicCommunity, baseBookmark, testUser1, communitiesAPIUser1, editedDescription);
