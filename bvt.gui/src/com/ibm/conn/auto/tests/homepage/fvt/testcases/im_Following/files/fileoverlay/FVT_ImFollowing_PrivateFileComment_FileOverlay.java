...
public class FVT_ImFollowing_PrivateFileComment_FileOverlay extends SetUpMethodsFVT {
	...
	*/
	...
	public void fileCommented_FileOverlay() {
		...
		FileEvents.addFileComment(testUser1, filesAPIUser1, sharedFile, user1Comment);
		...
		for(String filter : TEST_FILTERS) {
			...
			// Open the file details overlay for the comment on file event news story
