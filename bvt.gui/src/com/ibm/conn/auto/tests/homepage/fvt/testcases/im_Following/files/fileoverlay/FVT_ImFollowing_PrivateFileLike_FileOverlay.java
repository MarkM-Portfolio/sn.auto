...
public class FVT_ImFollowing_PrivateFileLike_FileOverlay extends SetUpMethodsFVT {
	...
	*/
	...
	public void fileLiked_FileOverlay(){
		...
		FileEvents.likeFile(testUser1, filesAPIUser1, sharedFile);
		...
		for(String filter : TEST_FILTERS) {
			...
			// Open the file details overlay for the shared file event news story
