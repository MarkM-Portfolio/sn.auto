...
public class FVT_ImFollowing_People_PublicCommunity_Wikis extends SetUpMethodsFVT {
	...
	public void setUpClass() {
		...
		// User 1 will now create a public community and will add the Wikis widget to the community
		...
		// Retrieve the community wiki for use in all tests
	...
	/**
	*<ul>
	*<li><B>Name: test_People_WikiWidget_PublicCommunity()</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/3F2C995463A320BF852578FC003AC9EF">TTT - AS - FOLLOW - PERSON - WIKIS - 00413 - wiki.library.created - PUBLIC COMMUNITY</a></li>
	*@author Srinivas Vechha
	*</ul>
	*/	
	@Test (groups={"fvtonprem", "fvtcloud"}, priority = 1)
	public void People_wikiWidget_PublicCommunity(){
	...
	/**
	*<ul>
	*<li><B>Name: test_People_createWikipage_PublicCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 log into Communities</B></li>
	*<li><B>Step: testUser 1 Open a community with public access that you have owner access to</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/98EB9992CDDF801D852578FC003ACFE4">TTT - AS - FOLLOW - PERSON - WIKIS - 00423 - wiki.page.created - PUBLIC COMMUNITY</a></li>
	*@author Srinivas Vechha
	*</ul>
	*/	
	@Test (groups={"fvtonprem", "fvtcloud"}, priority = 2)
	public void People_createWikipage_PublicCommunity(){
	...
	/**
	*<ul>
	*<li><B>Name: test_People_UpdateWikipage_PublicCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 log into Communities</B></li>
	*<li><B>Step: testUser 1 Open a community with public access that you have owner access to</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/68A73A684FE267C3852578FC003AF8F3">TTT - AS - FOLLOW - PERSON - WIKIS - 00433 - wiki.page.updated - PUBLIC COMMUNITY (NEG SC NOV)</a></li>
	*@author Srinivas Vechha
	*</ul>
	*/	
	@Test (groups={"fvtonprem", "fvtcloud"}, priority = 2)
	public void People_updateWikipage_PublicCommunity(){
	...
	/**
	*<ul>
	*<li><B>Name: test_People_LikeWikipage_PublicCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 log into Communities</B></li>
	*<li><B>Step: testUser 1 Open a community with public access that you have owner access to</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/1BD7533CBFEE6427852578FC0042AED2">TTT -  AS - FOLLOW - PERSON - WIKIS - 00453 - wiki.page.recommended - PUBLIC COMMUNITY</a></li>
	*</ul>
	*/	
	@Test (groups={"fvtonprem", "fvtcloud"}, priority = 2)
	public void People_likeWikipage_PublicCommunity(){
	...
	/**
	*<ul>
	*<li><B>Name: test_People_CommentedWikipage_PublicCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 log into Communities</B></li>
	*<li><B>Step: testUser 1 Open a community with public access that you have owner access to</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/4F6000BCBED6FBA9852578FC0042B6CA">TTT -  AS - FOLLOW - PERSON - WIKIS - 00463 - wiki.page.commented - PUBLIC COMMUNITY</a></li>
	*</ul>
	*/	
	@Test (groups={"fvtonprem", "fvtcloud"}, priority = 2)
	public void People_commentedWikipage_PublicCommunity(){
	...
	/**
	*<ul>
	*<li><B>Name: test_People_UpdateCommentWikipage_PublicCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 log into Communities</B></li>
	*<li><B>Step: testUser 1 Open a community with public access that you have owner access to</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/BC5C3E1C9EDAF251852579BF004A8379">TTT -  AS - FOLLOW - PERSON - WIKIS - 00468 - wiki.page.comment.updated - PUBLIC COMMUNITY (NEG SC NOV)</a></li>
	*</ul>
	*/	
	@Test (groups={"fvtonprem", "fvtcloud"}, priority = 2)
	public void People_updatecomment_PublicCommunity(){
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/6EC7B82BC8DCA00E85257C6F007A6869">TTT -AS - FOLLOW - PERSON - WIKIS - 00473 - Mention in a wiki comment - PUBLIC COMMUNITY</a></li>
	*</ul>
	*/	
	@Test (groups={"fvtonprem", "fvtcloud"}, priority = 2)
	public void People_mentionwikipagecomment_PublicCommunity(){
