...
public class FVT_ImFollowing_StatusUpdate_statusUpdatedeletComm extends SetUpMethodsFVT {
	...
	/**
	*<ul>
	*<li><B>Name: test_StatusUpdate_Remove Comment on StatusUpdates()</B></li>
	...
	*<li><B>Step: User 2 add a comment to the status update</B></li>
	*<li><B>Step: User 1 go to Homepage / Updates / I'm Following / All & Status Updates - #Verification Point 1</B></li>
	*<li><B>Step: User 2 delete the comment</B></li>
	*<li><B>Step: User 1 refresh the "I'm Following" view - #Verification Point 2</B></li>
	*<li><B>Verify: 1. Verify the Status Update comment is displayed in the I'm Following / All &  Status Updates filters</B></li>
	*<li><B>Verify: 2. Verify that the comment is NOT displayed in the I'm Following / All &  Status Updates filters</B></li>
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/FDD827C305F6DF64852579420031A76C">TTT - Homepage / I'm Following - 00012 - Remove comment on Status Updates</a></li>
	*@author Srinivas Vechha
	*</ul>
	*/	
	@Test (groups={"fvtonprem", "fvtcloud"})
	public void RemoveCommentonStatusUpdate(){
			
		ui.startTest();
		
		// User 2 will now comment on their status update
		String user2Comment = Data.getData().commonComment + Helper.genStrongRand();
		String user2CommentId = ProfileEvents.addStatusUpdateComment(user2StatusUpdateId, user2Comment, profilesAPIUser2);
		...
		// User 2 will now delete the comment again
		ProfileEvents.deleteComment(user2StatusUpdateId, user2CommentId, profilesAPIUser2);
		
		for(String filter : TEST_FILTERS) {
			// Verify that User 2's status update is displayed in all views
			HomepageValid.verifyItemsInAS(ui, driver, new String[]{user2StatusUpdate}, filter, true);
			
			// Verify that the comment on status update event and User 2's comment are NOT displayed in any of the views
			HomepageValid.verifyItemsInAS(ui, driver, new String[]{commentOnStatusEvent, user2Comment}, null, false);
		}
		ui.endTest();
	}			
}