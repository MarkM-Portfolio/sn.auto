...
public class FVT_ImFollowing_Tags_PublicCommunity_Forums extends SetUpMethodsFVT {
	...
	/**
	*<ul>
	*<li><B>Name: test_Tags_CreateForum_PublicCommunity()</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/40B673E03555309F852578FC0051843C">TTT - AS - FOLLOW - TAG - FORUMS - 00162 - forum.created - PUBLIC COMMUNITY</a></li>
	*</ul>
	*/		
	@Test(groups = {"fvtonprem", "fvtcloud"})	
	public void forumCreation_PublicCommunity(){			
		...
		CommunityForumEvents.createForum(publicCommunity, serverURL, testUser2, communitiesAPIUser2, forumsAPIUser2, baseForum);
	...
	/**
	*<ul>
	*<li><B>Name: test_Tags_CreateTopic_PublicCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 log into Connections</B></li>
	*<li><B>Step: testUser 1 follow a tag</B></li>
	*<li><B>Step: testUser 2 log into Connections</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/CD7068DB444691D7852578FD002B1891">TTT - AS - FOLLOW - TAG - FORUMS - 00182 - forum.topic.created - PUBLIC COMMUNITY</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void topicCreation_PublicCommunity(){
		...
		CommunityForumEvents.createForumTopic(testUser2, communitiesAPIUser2, publicCommunity, baseForumTopic);
	...
	/**
	*<ul>
	*<li><B>Name: test_Tags_UpdateTopic_PublicCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 log into Connections</B></li>
	*<li><B>Step: testUser 1 follow a tag</B></li>
	*<li><B>Step: testUser 2 log into Connections</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/CCD08F086F0B1A23852579BB00770F87 ">TTT - AS - FOLLOW - TAG - FORUMS - 00186 - forum.topic.updated - PUBLIC COMMUNITY</a></li>
	*</ul>
	*/	
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void updatetopic_PublicCommunity(){
		...
		BaseForumTopic baseForumTopic = ForumBaseBuilder.buildCommunityBaseForumTopicWithCustomTag(testName + Helper.genStrongRand(), baseCommunity, tagToFollow);
		CommunityForumEvents.createForumTopicAndEditDescription(testUser2, communitiesAPIUser2, publicCommunity, baseForumTopic, forumsAPIUser2, editedDescription);
