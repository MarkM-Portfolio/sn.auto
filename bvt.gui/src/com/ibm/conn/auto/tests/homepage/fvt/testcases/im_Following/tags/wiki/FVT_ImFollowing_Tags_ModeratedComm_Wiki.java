...
public class FVT_ImFollowing_Tags_ModeratedComm_Wiki extends SetUpMethodsFVT {
	...
	public void setUpClass() {
		...
		// User 2 will now create a moderated community with the Wiki widget added
		baseCommunity = CommunityBaseBuilder.buildBaseCommunity(getClass().getSimpleName() + Helper.genStrongRand(), Access.MODERATED);
		moderatedCommunity = CommunityEvents.createNewCommunityAndAddWidget(baseCommunity, BaseWidget.WIKI, isOnPremise, testUser2, communitiesAPIUser2);
		
		// User 2 will now create a moderated community with custom tag included and with the Wiki widget added
		...
		moderatedCommunityWithTag = CommunityEvents.createNewCommunityAndAddWidget(baseCommunityWithTag, BaseWidget.WIKI, isOnPremise, testUser2, communitiesAPIUser2);
	
		// Retrieve the relevant community wiki (ie. from the community without the custom tag) for use in all relevant tests
		communityWiki = CommunityWikiEvents.getCommunityWiki(moderatedCommunity, wikisAPIUser2);
	}
	...
	/**
	*<ul>
	*<li><B>Name: test_Tags_wiki.library.created_ModerateCommunity()</B></li>
	...
	*<li><B>Step: testUser 2 go to a Moderate community that you have owner access</B></li>
	...
	*<li><B>Verify: Verify that the wiki.library.created story is displayed in Homepage / All Updates filtered by Communities, Tags and Wikis</B></li>
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/8D94E7A56C5DA41A852578FD002CF5F7">TTT - AS - FOLLOW - TAG - WIKIS - 00214 - wiki.library.created - MODERATE COMMUNITY</a></li>
	*</ul>
	*/	
	@Test (groups={"fvtonprem", "fvtcloud"})
	public void wikilibrarycreated_ModerateCommunity() {
		...
		HomepageValid.verifyItemsInASUsingMultipleFilters(ui, driver, new String[]{createWikiEvent, baseCommunityWithTag.getDescription()}, TEST_FILTERS, true);
	...
	/**
	*<ul>
	*<li><B>Name: test_Tags_wiki.page.created_ModerateCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 log into Connections</B></li>
	*<li><B>Step: testUser 1 follow a tag</B></li>
	*<li><B>Step: testUser 2 log into Connections</B></li>
	...
	*<li><B>Step: testUser 1 log into Homepage / Updates / I'm Following / All, Communities, Wikis & Tags (All Tags / {TagName}</B></li>
	*<li><B>Verify: Verify that the wiki.page.created story is displayed in Homepage / All Updates filtered by Communities, Tags and Wikis</B></li>
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/28683B50B3B54D3C852578FD002CFC64">TTT - AS - FOLLOW - TAG - WIKIS - 00224 - wiki.page.created - MODERATE COMMUNITY</a></li>
	*</ul>
	*/	
	@Test (groups={"fvtonprem", "fvtcloud"})
	...
	/**
	*<ul>
	*<li><B>Name: test_Tags_WikiPageUpdated_ModerateCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 log into Connections</B></li>
	*<li><B>Step: testUser 1 follow a tag</B></li>
	*<li><B>Step: testUser 2 log into Connections</B></li>
	*<li><B>Step: testUser 2 go to a Moderate community that you have owner access</B></li>
	*<li><B>Step: testUser 2 created the wikipage and add the tag User 1 is following</B></li></B></li>
	*<li><B>Step: testUser 2 update a wiki page</B></li></B></li>
	*<li><B>Step: testUser 1 log into Homepage / Updates / I'm Following / All, Communities, Wikis & Tags (All Tags / {TagName}</B></li>
	*<li><B>Verify: Verify that the wiki.page.updated story is displayed in Homepage / All Updates filtered by Communities, Tags and Wikis</B></li>
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/0DA2F9AEB7B983EA852578FD002D012F">TTT - AS - FOLLOW - TAG - WIKIS - 00234 - wiki.page.updated - MODERATE COMMUNITY</a></li>
	*</ul>
	*/	
	@Test (groups={"fvtonprem", "fvtcloud"})
