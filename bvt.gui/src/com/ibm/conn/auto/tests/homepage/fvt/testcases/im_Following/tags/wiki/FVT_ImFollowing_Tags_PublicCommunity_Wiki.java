...
public class FVT_ImFollowing_Tags_PublicCommunity_Wiki extends SetUpMethodsFVT {
	...
	public void setUpClass() {
		...
		// User 2 will now create a public community with the Wiki widget added
		baseCommunity = CommunityBaseBuilder.buildBaseCommunity(getClass().getSimpleName() + Helper.genStrongRand(), Access.PUBLIC);
		publicCommunity = CommunityEvents.createNewCommunityAndAddWidget(baseCommunity, BaseWidget.WIKI, isOnPremise, testUser2, communitiesAPIUser2);
		
		// User 2 will now create a public community with custom tag included and with the Wiki widget added
		...
		publicCommunityWithTag = CommunityEvents.createNewCommunityAndAddWidget(baseCommunityWithTag, BaseWidget.WIKI, isOnPremise, testUser2, communitiesAPIUser2);
	
		// Retrieve the relevant community wiki (ie. from the community without the custom tag) for use in all relevant tests
		communityWiki = CommunityWikiEvents.getCommunityWiki(publicCommunity, wikisAPIUser2);
	}
	...
	/**
	*<ul>
	*<li><B>Name: test_Tags_wiki.library.created_PublicCommunity()</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/CAAA4390B9726E14852578FD002CF4AF">TTT - AS - FOLLOW - TAG - WIKIS - 00213 - wiki.library.created - PUBLIC COMMUNITY</a></li>
	*</ul>
	*/	
	@Test (groups={"fvtonprem", "fvtcloud"})
	public void wikilibrarycreated_PublicCommunity(){
	...
	/**
	*<ul>
	*<li><B>Name: test_Tags_wiki.page.created_PublicCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 log into Connections</B></li>
	*<li><B>Step: testUser 1 follow a tag</B></li>
	*<li><B>Step: testUser 2 log into Connections</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/5537491FE51CE942852578FD002CFB09">TTT - AS - FOLLOW - TAG - WIKIS - 00223 - wiki.page.created - PUBLIC COMMUNITY</a></li>
	*</ul>
	*/	
	@Test (groups={"fvtonprem", "fvtcloud"})
	public void createWikipage_PublicCommunity(){
	...
	/**
	*<ul>
	*<li><B>Name: test_Tags_WikiPageUpdated_PublicCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 log into Connections</B></li>
	*<li><B>Step: testUser 1 follow a tag</B></li>
	*<li><B>Step: testUser 2 log into Connections</B></li>
	*<li><B>Step: testUser 2 go to a public community that you have owner access</B></li>
	*<li><B>Step: testUser 2 created the wikipage and add the tag User 1 is following</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/E380948919306495852578FD002D095D">TTT - AS - FOLLOW - TAG - WIKIS - 00233 - wiki.page.updated - PUBLIC COMMUNITY</a></li>
	*</ul>
	*/	
	@Test (groups={"fvtonprem", "fvtcloud"})
