...
public class FVT_ImFollowing_Wikis_PublicCommunity extends SetUpMethodsFVT {
...
private final String[] TEST_FILTERS = { HomepageUIConstants.FilterAll, HomepageUIConstants.FilterCommunities, HomepageUIConstants.FilterWikis };
	...
	public void setUpClass() {
		...
		// User 1 will now create a public community with User 2 added as a follower and the Wiki widget added
		baseCommunity = CommunityBaseBuilder.buildBaseCommunity(getClass().getSimpleName(), Access.PUBLIC);
		publicCommunity = CommunityEvents.createNewCommunityWithOneFollowerAndAddWidget(baseCommunity, testUser2, communitiesAPIUser2, BaseWidget.WIKI, testUser1, communitiesAPIUser1, isOnPremise);
	...
	/**
	*<ul>
	*<li><B>Name: test_Wikis_wiki.library.created_PublicCommunity()</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/1753DC9269DEDA29852578F8003C4FAC">TTT - AS - FOLLOW - WIKIS - 00013 - wiki.library.created - PUBLIC COMMUNITY</a></li>
	*@author Srinivas Vechha
	*</ul>
	*/	
	@Test (groups={"fvtonprem", "fvtcloud"}, priority = 1)
	public void wikis_Wikilibrarycreated_PublicCommunity(){
	...
	/**
	*<ul>
	*<li><B>Name: test_Wikis_createWikipage_PublicCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 log into Communities</B></li>
	*<li><B>Step: testUser 1 Open a community with public access that you have owner access to</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/3B4514D19BB3E5BA852578F8004630C8">TTT - AS - FOLLOW - WIKIS - 00023 - wiki.page.created - PUBLIC COMMUNITY</a></li>
	*@author Srinivas Vechha
	*</ul>
	*/	
	@Test (groups={"fvtonprem", "fvtcloud"}, priority = 2)
	public void wikis_CreateWikipage_PublicCommunity(){
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/A465FB1A0F373929852578F80048030F">TTT - AS - FOLLOW - WIKIS - 00033 - wiki.page.updated - PUBLIC COMMUNITY</a></li>
	*@author Srinivas Vechha
	*</ul>
	*/	
	@Test (groups={"fvtonprem", "fvtcloud"}, priority = 2)
	public void wikis_UpdateWikipage_PublicCommunity(){
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/CA35C53966162D1D85257BD60047D84B">TTT -  AS - FOLLOW - WIKIS - 00053 - wiki.page.recommended - PUBLIC COMMUNITY</a></li>
	*</ul>
	*/		
	@Test (groups={"fvtonprem", "fvtcloud"}, priority = 2)
	public void wikis_LikeWikipage_PublicCommunity(){
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/5690D0ADC60A4A5C852578F80050602C">TTT -AS - FOLLOW - WIKIS - 00063 - wiki.page.commented - PUBLIC COMMUNITY</a></li>
	*</ul>
	*/	
	@Test (groups={"fvtonprem", "fvtcloud"}, priority = 2)
	public void wikis_CommentedWikipage_PublicCommunity(){
	...
	/**
	*<ul>
	*<li><B>Name: test_Wikis_UpdateCommentWikipage_PublicCommunityCloud()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 log into Communities</B></li>
	*<li><B>Step: testUser 1 Open a community with public access that you have owner access to</B></li>
	*<li><B>Step: testUser 2 Log in to Home who is following the community</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/CB682C9F16269BC0852579BB006D62AB">TTT -AS - FOLLOW - WIKIS - 00073 - wiki.page.comment.updated - PUBLIC COMMUNITY</a></li>
	*</ul>
	*/	//
	@Test (groups={"fvtonprem", "fvtcloud"}, priority = 2)
	public void wikis_Updatecomment_PublicCommunity(){
	...
	/**
	*<ul>
	*<li><B>Name: test_Wikis_Mention in a wikipage Comment_PublicCommunity()</B></li>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser 1 log into Communities</B></li>
	...
	*<li><a HREF="Notes://Parallan/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/DAEB0E3D832BCE0885257C6F0077F114">TTT -AS - FOLLOW - WIKIS - 00163 - Mention in a wiki comment - PUBLIC COMMUNITY</a></li>
	*</ul>
	*/	
	@Test(groups={"fvtonprem", "fvtcloud"}, priority = 2)
	public void wikis_MentionInawikipagecomment_PublicCommunity(){
