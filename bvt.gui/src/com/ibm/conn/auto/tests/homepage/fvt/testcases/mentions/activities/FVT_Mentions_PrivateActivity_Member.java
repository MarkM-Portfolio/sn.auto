...
public class FVT_Mentions_PrivateActivity_Member extends SetUpMethodsFVT {
	...
	public void setUpClass() {
		...
		// User 1 will now create a private standalone activity with User 2 added as a member
	...
	/**
	* activities_directedMention_privateActivityEntry_Member() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 start a private activity adding User 2 as a member</B></li>
	...
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/FDC900EEDD6EA4E785257C93004EAC43">TTT - @MENTIONS - 041 - MENTIONS DIRECTED TO YOU IN ACTIVITY ENTRY - PRIVATE ACTIVITY - MEMBER</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void activities_directedMention_privateActivityEntry_Member(){
	...
	/**
	* activities_directedMention_privateActivityToDo_Member() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 start a private activity adding User 2 as a member</B></li>
	...
	*<li><B>Step: testUser2 go to Homepage / Updates / I'm Following / All</B></li>
	*<li><B>Verify: Verify the event for the mentions appears in both views</B></li>
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/404A83CFF646F50D85257C93004EAC4A">TTT - @MENTIONS - 051 - MENTIONS DIRECTED TO YOU IN ACTIVITY TO-DO - PRIVATE ACTIVITY - MEMBER</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void activities_directedMention_privateActivityToDo_Member(){
	...
	/**
	* activities_directedMention_privateActivityEntry_Comment_Member() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 start a private activity adding User 2 as a member</B></li>
	...
	*<li><B>Step: testUser2 go to Homepage / Updates / I'm Following / All</B></li>
	*<li><B>Verify: Verify the event for the mentions appears in both views</B></li>
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/EB4D7F59F6B764DE85257C6F007CE314">TTT - @MENTIONS - 041 - MENTIONS DIRECTED TO YOU IN ACTIVITY ENTRY COMMENT - PRIVATE ACTIVITY - MEMBER</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void activities_directedMention_privateActivityEntry_Comment_Member(){
	...
	/**
	* activities_directedMention_privateActivityToDo_Comment_Member() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 start a private activity adding User 2 as a member</B></li>
	...
	*<li><B>Step: testUser2 go to Homepage / Updates / I'm Following / All</B></li>
	*<li><B>Verify: Verify the event for the mentions appears in both views</B></li>
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/A4A51FAC02F0367A85257C6F007E0442">TTT - @MENTIONS - 051 - MENTIONS DIRECTED TO YOU IN ACTIVITY TO-DO COMMENT - PRIVATE ACTIVITY - MEMBER</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void activities_directedMention_privateActivityToDo_Comment_Member(){
