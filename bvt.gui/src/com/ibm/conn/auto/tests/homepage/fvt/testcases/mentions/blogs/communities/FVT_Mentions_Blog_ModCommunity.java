...
public class FVT_Mentions_Blog_ModCommunity extends SetUpMethodsFVT {
	...
	/**
	* mention_modCommunity_blogEntry_mentionsView() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 go to a moderated community they own</B></li>
	...
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/194DAB032D0F1FEF85257CAC004D50D3">TTT - @MENTIONS - 112 - MENTIONS DIRECTED TO YOU IN A BLOG ENTRY - MODERATE COMMUNITY BLOG</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void mention_modCommunity_blogEntry_mentionsView(){
		...
		CommunityBlogEvents.createBlogPostWithMentions(testUser1, communityBlogsAPIUser1, baseBlogPost, moderatedCommunity, mentions);
	...
	/**
	* mention_modCommunity_blogEntry_Comment_mentionsView() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 go to a moderated community they own</B></li>
	*<li><B>Step: testUser1 customize and add the Blogs widget</B></li>
	...
	*<li><B>Verify: Verify that testUser2 can see the mentions event in the Mentions view</B></li>
	*<li><B>Verify: Verify that testUser2 can see the mentions event in the filters in the I'm Following view</B></li>
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/0B2AC303776553BD85257CAC004D50D8">TTT - @MENTIONS - 132 - MENTIONS DIRECTED TO YOU IN A BLOG ENTRY COMMENT - MODERATE COMMUNITY BLOG</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void mention_modCommunity_blogEntry_Comment_mentionsView(){
		...
		Mentions mentions = MentionsBaseBuilder.buildBaseMentions(testUser2, profilesAPIUser2, serverURL, Helper.genStrongRand(), Helper.genStrongRand());
		BaseBlogPost baseBlogPost = BlogBaseBuilder.buildBaseBlogPost(testName + Helper.genStrongRand());
		CommunityBlogEvents.createBlogPostAndAddCommentWithMentions(testUser1, communityBlogsAPIUser1, baseBlogPost, moderatedCommunity, mentions);
