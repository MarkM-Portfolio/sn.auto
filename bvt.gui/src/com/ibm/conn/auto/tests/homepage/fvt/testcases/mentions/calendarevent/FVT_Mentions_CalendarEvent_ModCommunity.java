...
public class FVT_Mentions_CalendarEvent_ModCommunity extends SetUpMethodsFVT {
	...
	public void setUpClass() {
		...
		// User 1 will now create a moderated community with the Events widget added
		baseCommunity = CommunityBaseBuilder.buildBaseCommunity(getClass().getSimpleName() + Helper.genStrongRand(), Access.MODERATED);
		moderatedCommunity = CommunityEvents.createNewCommunityAndAddWidget(baseCommunity, BaseWidget.EVENTS, isOnPremise, testUser1, communitiesAPIUser1);
	}
	...
	/**
	* calendarEvents_directedMention_modCommunity_event() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 start a moderated community</B></li>
	*<li><B>Step: testUser1 add the events widget to the moderated community</B></li>
	...
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/33B5433C4068CABF85257C98005ACDF9">TTT - @MENTIONS - 121 - MENTIONS DIRECTED TO YOU IN CALENDAR EVENT - MODERATE COMMUNITY</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void calendarEvents_directedMention_modCommunity_event() {
		...
		CommunityCalendarEvents.addCalendarEventWithMentions(moderatedCommunity, baseEvent, mentions, testUser1, calendarAPIUser1);
	...
	/**
	* calendarEvents_directedMention_modCommunity_eventComment() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 start a moderated community</B></li>
	*<li><B>Step: testUser1 add the events widget to the moderated community</B></li>
	...
	*<li><B>Step: testUser2 go to Homepage / Mentions</B></li>
	*<li><B>Verify: Verify that the mentions event appears in the Mentions view</B></li>
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/2448E1444A736FB085257C980059537B">TTT - @MENTIONS - 111 - MENTIONS DIRECTED TO YOU IN CALENDAR EVENT COMMENT - MODERATE COMMUNITY</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void calendarEvents_directedMention_modCommunity_eventComment() {
		...
		BaseEvent baseEvent = EventBaseBuilder.buildBaseCalendarEvent(testName + Helper.genStrongRand(), false);
		CommunityCalendarEvents.addCalendarEventAndAddCommentWithMentions(moderatedCommunity, baseEvent, mentions, testUser1, calendarAPIUser1);
