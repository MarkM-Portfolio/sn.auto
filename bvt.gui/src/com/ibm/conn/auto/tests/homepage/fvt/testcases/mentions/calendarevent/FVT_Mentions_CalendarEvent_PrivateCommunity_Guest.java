...
public class FVT_Mentions_CalendarEvent_PrivateCommunity_Guest extends SetUpMethods2{
	private static Logger log = LoggerFactory.getLogger(FVT_Mentions_CalendarEvent_PrivateCommunity_Guest.class);
	...
	/**
	* calendarEvents_directedMention_privateCommunity_event_guest() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 start a private community and add testUser2, who is a guest user, as a member</B></li>
	...
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/2BD758EDB4828F8B85257C98005B385A">TTT - @MENTIONS - 124 - MENTIONS DIRECTED TO YOU IN CALENDAR EVENT - GUEST USER - SC ONLY</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtcloud"})
	public void calendarEvents_directedMention_privateCommunity_event_guest() throws Exception{
		...
		if(!event.getEndDateText().isEmpty()){
			...
			log.info("INFO: Changing end date to " + event.getEndDate());	
	...
	/**
	* calendarEvents_directedMention_privateCommunity_eventComment_guest() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 start a private community and add testUser2, who is a guest user, as a member</B></li>
	*<li><B>Step: testUser1 add the events widget to the private community</B></li>
	...
	*/
	@Test(groups = {"fvtcloud"})
	public void calendarEvents_directedMention_privateCommunity_eventComment_guest() throws Exception{
