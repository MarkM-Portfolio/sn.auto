...
public class FVT_Mentions_ForumReply_FollowForum extends SetUpMethodsFVT {
	...
	public void setUpClass() {
		...
		// User 1 will now create a standalone forum with User 2 following the forum
		baseForum = ForumBaseBuilder.buildBaseForum(getClass().getSimpleName() + Helper.genStrongRand());
		standaloneForum = ForumEvents.createForumWithOneFollower(testUser1, forumsAPIUser1, testUser2, forumsAPIUser2, baseForum);
	}
	...
	/**
	* replyMention_forumTopic_followForum() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 logs into Forums</B></li>
	*<li><B>Step: testUser1 start a forum</B></li>
	*<li><B>Step: testUser2 follow the forum</B></li>
	*<li><B>Step: testUser1 add a topic</B></li>
	*<li><B>Step: testUser1 reply to the topic with a mentions to testUser3</B></li>
	*<li><B>Step: testUser2 who is in the SAME organisation log into Homepage / Updates / I'm Following / All & Forums</B></li>
	*<li><B>Verify: Verify that testUser2 can see the mentions event in the filters in the I'm Following view</B></li>
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/2567E30ECF416E2685257C84005ECFE0">TTT - AS - FOLLOW - FORUMS - 00190 - FORUMS REPLY WITH MENTIONS - STANDALONE FORUM</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtonprem"})
	public void replyMention_forumTopic_followForum(){
