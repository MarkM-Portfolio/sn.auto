...
public class FVT_Mentions_ForumTopic_Communities_MentionsView extends SetUpMethodsFVT {
	...
	/**
	* mention_forumTopic_mentionsView_publicCommunity() 
	*<ul>
	...
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/0AA9EE78253F514285257C9200420351">TTT - @MENTIONS - 081 - MENTIONS DIRECTED TO YOU IN A FORUM TOPIC - PUBLIC COMMUNITY FORUM</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void mention_forumTopic_mentionsView_publicCommunity(){
		
		String testName = ui.startTest();
		
		// User 1 will now create a forum topic with mentions to User 2 in the community forum
		...
		CommunityForumEvents.createForumTopicWithMentions(publicCommunity, baseForumTopic, mentions, testUser1, communitiesAPIUser1);
		
		// Log in as User 2 and go to the Mentions view
		LoginEvents.loginAndGotoMentions(ui, testUser2, false);
		
		// Create the news stories to be verified
		String mentionEvent = CommunityForumNewsStories.getMentionedYouInATopicNewsStory(ui, baseForumTopic.getTitle(), publicBaseCommunity.getName(), testUser1.getDisplayName());
	...
	/**
	* mention_forumTopic_mentionsView_modCommunity() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 logs into Communities</B></li>
	...
	*<li><B>Verify: Verify that testUser2 can see the mentions event in the filters in the I'm Following view</B></li>
	*<li><B>Verify: Verify that testUser2 can see the mentions event in the Mentions view</B></li>
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/CA64F5623F0666E085257C84005B32F1">TTT - @MENTIONS - 082 - MENTIONS DIRECTED TO YOU IN A FORUM TOPIC - MODERATE COMMUNITY FORUM</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void mention_forumTopic_mentionsView_modCommunity(){
		...
		CommunityForumEvents.createForumTopicWithMentions(moderatedCommunity, baseForumTopic, mentions, testUser1, communitiesAPIUser1);
				
		// Log in as User 2 and go to the Mentions view
		LoginEvents.loginAndGotoMentions(ui, testUser2, false);
		
		// Create the news stories to be verified
		String mentionEvent = CommunityForumNewsStories.getMentionedYouInATopicNewsStory(ui, baseForumTopic.getTitle(), moderatedBaseCommunity.getName(), testUser1.getDisplayName());
		String topicDescriptionWithMentions = mentions.getBeforeMentionText() + " @" + mentions.getUserToMention().getDisplayName() + " " + mentions.getAfterMentionText();
	...
	/**
	* mention_forumTopic_mentionsView_privateCommunity_nonMember() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 logs into Communities</B></li>
	...
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/619420E68317B74185257C9200420353">TTT - @MENTIONS - 083 - MENTIONS DIRECTED TO YOU IN A FORUM TOPIC - PRIVATE COMMUNITY FORUM - NON MEMBER</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void mention_forumTopic_mentionsView_privateCommunity_nonMember(){
		...
		CommunityForumEvents.createForumTopicWithMentions(restrictedCommunity, baseForumTopic, mentions, testUser1, communitiesAPIUser1);
		
		// Log in as User 2 and go to the Mentions view
		LoginEvents.loginAndGotoMentions(ui, testUser2, false);
		
		// Create the news stories to be verified
		String mentionEvent = CommunityForumNewsStories.getMentionedYouInATopicNewsStory(ui, baseForumTopic.getTitle(), restrictedBaseCommunity.getName(), testUser1.getDisplayName());
		String topicDescriptionWithMentions = mentions.getBeforeMentionText() + " @" + mentions.getUserToMention().getDisplayName() + " " + mentions.getAfterMentionText();
		
		// Verify that the mentions event and the forum topic description with mentions are NOT displayed in the Mentions view
		HomepageValid.verifyItemsInAS(ui, driver, new String[]{mentionEvent, topicDescriptionWithMentions}, null, false);
		
		// Navigate to the I'm Following view
		UIEvents.gotoImFollowing(ui);
		
		// Verify that the mentions event and the forum topic description with mentions are NOT displayed in any of the views
		HomepageValid.verifyItemsInASUsingMultipleFilters(ui, driver, new String[]{mentionEvent, topicDescriptionWithMentions}, TEST_FILTERS, false);
				
		ui.endTest();
	}
	
	/**
	* mention_forumTopic_mentionsView_privateCommunity_member() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 logs into Communities</B></li>
	*<li><B>Step: testUser1 start a private community</B></li>
	...
	*<li><B>Verify: Verify that testUser2 can see the mentions event in the filters in the I'm Following view</B></li>
	*<li><B>Verify: Verify that testUser2 can see the mentions event in the Mentions view</B></li>
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/F693A5A76E49D35085257C9200420354">TTT - @MENTIONS - 084 - MENTIONS DIRECTED TO YOU IN A FORUM TOPIC - PRIVATE COMMUNITY FORUM - MEMBER</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void mention_forumTopic_mentionsView_privateCommunity_member(){
		...
		CommunityForumEvents.createForumTopicWithMentions(restrictedCommunityWithMember, baseForumTopic, mentions, testUser1, communitiesAPIUser1);
		
		// Log in as User 2 and go to the Mentions view
		LoginEvents.loginAndGotoMentions(ui, testUser2, false);
		
		// Create the news stories to be verified
		String mentionEvent = CommunityForumNewsStories.getMentionedYouInATopicNewsStory(ui, baseForumTopic.getTitle(), restrictedBaseCommunityWithMember.getName(), testUser1.getDisplayName());
		String topicDescriptionWithMentions = mentions.getBeforeMentionText() + " @" + mentions.getUserToMention().getDisplayName() + " " + mentions.getAfterMentionText();
