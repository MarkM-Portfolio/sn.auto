...
public class FVT_Mentions_IdeationBlog_ModCommunity extends SetUpMethodsFVT {
	...
	/**
	* mention_modCommunity_IdeationIdea_mentionsView() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 go to a moderate community they own</B></li>
	...
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/886315C72568C87D85257CAC004E2642">TTT - @MENTIONS - 121 - MENTIONS DIRECTED TO YOU IN AN IDEATION BLOG IDEA - MODERATE COMMUNITY IDEATION BLOG</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void mention_modCommunity_IdeationIdea_mentionsView(){
		...
		CommunityBlogEvents.createIdeationBlogIdeaWithMentions(testUser1, communityBlogsAPIUser1, mentions, baseBlogPost, moderatedCommunity);
	...
	/**
	* mention_modCommunity_IdeationIdea_Comment_mentionsView() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 go to a moderate community they own</B></li>
	*<li><B>Step: testUser1 customize and add the Ideation Blogs widget</B></li>
	...
	*<li><B>Verify: Verify that testUser2 can see the mentions event in the Mentions view</B></li>
	*<li><B>Verify: Verify that testUser2 can see the mentions event in the filters in the I'm Following view</B></li>
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/7C1AA9577169518485257CAC005389FF">TTT - @MENTIONS - 141 - MENTIONS DIRECTED TO YOU IN AN IDEATION BLOG IDEA COMMENT - MODERATE COMMUNITY IDEATION BLOG</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void mention_modCommunity_IdeationIdea_Comment_mentionsView(){
		...
		Mentions mentions = MentionsBaseBuilder.buildBaseMentions(testUser2, profilesAPIUser2, serverURL, Helper.genStrongRand(), Helper.genStrongRand());
		BaseBlogPost baseBlogPost = BlogBaseBuilder.buildBaseBlogPost(testName + Helper.genStrongRand());
		CommunityBlogEvents.createIdeaAndAddCommentWithMention(testUser1, communityBlogsAPIUser1, baseBlogPost, moderatedCommunity, mentions);
