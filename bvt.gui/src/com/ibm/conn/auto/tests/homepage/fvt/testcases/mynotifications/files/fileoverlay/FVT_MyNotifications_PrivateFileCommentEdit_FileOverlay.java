...
public class FVT_MyNotifications_PrivateFileCommentEdit_FileOverlay extends SetUpMethodsFVT {
	...
	/**
	* fileCommentEdited_OtherUser_FileOverlay() 
	*<ul>
	...
	*<li><B>Step: User 2 edit the comment</B></li>
	*<li><B>Step: User 1 go to Homepage / Updates / My Notifications / For Me / All & Files, selects the story</B></li>
	...
	*/
	...
	public void fileCommentEdited_OtherUser_FileOverlay() {
		
		ui.startTest();
		
		// User 2 will now post a comment to the file
		String user2Comment = Data.getData().commonComment + Helper.genStrongRand();
		FileComment user2FileComment = FileEvents.addFileCommentOtherUser(testUser2, filesAPIUser2, sharedFile, user2Comment, profilesAPIUser1);
		
		// User 2 will now edit the comment posted to the file
		String user2UpdatedComment = Data.getData().commonComment + Helper.genStrongRand();
		FileEvents.updateFileComment(testUser2, filesAPIUser2, sharedFile, user2FileComment, user2UpdatedComment);
