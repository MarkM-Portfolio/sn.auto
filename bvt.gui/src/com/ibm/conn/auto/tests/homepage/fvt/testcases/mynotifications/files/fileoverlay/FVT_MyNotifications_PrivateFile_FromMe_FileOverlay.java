...
public class FVT_MyNotifications_PrivateFile_FromMe_FileOverlay extends SetUpMethodsFVT {
	...
	*/
	...
	public void fileShared_FromMe_FileOverlay() {
		...
		String sharedFileEvent = FileNewsStories.getSharedAFileNewsStory(ui, testUser1.getDisplayName());
