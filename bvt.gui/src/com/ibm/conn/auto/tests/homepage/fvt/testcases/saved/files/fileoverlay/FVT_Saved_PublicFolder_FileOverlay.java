...
public class FVT_Saved_PublicFolder_FileOverlay extends SetUpMethodsFVT {
	...
	*/
	...
	public void test_SavedFolder_FileOverlay() {
		...
		// Save the add file to folder event using the UI
		UIEvents.saveNewsStoryUsingUI(ui, addFileToFolderEvent);
