...
public class FVT_FilePreview_AS_Compatible_doc_docx extends SetUpMethodsFVT {
	...
	private BaseFile baseFileDoc, baseFileDocx;
	private FileEntry publicFileDoc, publicFileDocx;
	...
	public void setUpClass() {
		...
		// User 1 will create a public doc file
		baseFileDoc = FileBaseBuilder.buildBaseFile(Data.getData().file24, ".doc", ShareLevel.EVERYONE);
		publicFileDoc = FileEvents.addFile(baseFileDoc, testUser1, filesAPIUser1);
		
		// User 1 will create a public docx file
		baseFileDocx = FileBaseBuilder.buildBaseFile(Data.getData().file16, ".docx", ShareLevel.EVERYONE);
		publicFileDocx = FileEvents.addFile(baseFileDocx, testUser1, filesAPIUser1);
	}
	...
	public void performCleanUp() {
		...
		filesAPIUser1.deleteFile(publicFileDoc);
		filesAPIUser1.deleteFile(publicFileDocx);
	}
	
	/**
	* filePreview_docFile_uploaded() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 go to Files</B></li>
	*<li><B>Step: testUser1 upload a new .doc file with public access</B></li>
	...
	*/
	...
	public void filePreview_docFile_uploaded(){
		...
		String fileDetails = baseFileDoc.getRename() + baseFileDoc.getExtension();
		...
		for(String filter : TEST_FILTERS) {
			...
			HomepageValid.verifyFilesNewsStoryIsDisplayedInAS(ui, driver, fileUploadEvent, baseFileDoc);
			
			// Verify that the file details box is displayed in all views
			HomepageValid.verifyFileDetailsBox(ui, driver, baseFileDoc, fileDetails, nameDetails, null, true);
		}		
		ui.endTest();
	}

	/**
	* filePreview_docxFile_uploaded() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 go to Files</B></li>
	*<li><B>Step: testUser1 upload a new .docx file with public access</B></li>
	*<li><B>Step: testUser2 go to Homepage / Updates / Discover / All & Files</B></li>
	*<li><B>Step: testUser2 look at the story for the file uploaded</B></li>
	*<li><B>Verify: Verify the file uploaded event displays a preview image of the first page of the file added as the first item, with a details/description box underneath it</B></li>
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/B912DEDAF63B194A85257D0E00508BDA">TTT - FILE PREVIEW - 00010 - File Created - Compatible Public File - Preview image appears</a></li>
	...
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void filePreview_docxFile_uploaded(){
		...
		// Create the file details to be verified
		String fileDetails = baseFileDocx.getRename() + baseFileDocx.getExtension();
		String nameDetails = testUser1.getDisplayName() + profilesAPIUser1.getUUID();
		...
		for(String filter : TEST_FILTERS) {
			...
			// Verify that the file uploaded news story is displayed in all views
			HomepageValid.verifyFilesNewsStoryIsDisplayedInAS(ui, driver, fileUploadEvent, baseFileDocx);
			
			// Verify that the file details box is displayed in all views
			HomepageValid.verifyFileDetailsBox(ui, driver, baseFileDocx, fileDetails, nameDetails, null, true);
		}		
		ui.endTest();	
	}
}
