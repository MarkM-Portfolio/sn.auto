...
public class FVT_FilePreview_AS_Compatible_ods_odp extends SetUpMethodsFVT {
	...
	private BaseFile baseFileOdp, baseFileOds;
	private FileEntry publicFileOdp, publicFileOds;
	...
	public void setUpClass() {
		...
		// User 1 will create a public ods file
		baseFileOds = FileBaseBuilder.buildBaseFile(Data.getData().file18, ".ods", ShareLevel.EVERYONE);
		publicFileOds = FileEvents.addFile(baseFileOds, testUser1, filesAPIUser1);
	}
	...
	public void performCleanUp() {
		...
		filesAPIUser1.deleteFile(publicFileOds);
	}

	/**
	* filePreview_odpFile_uploaded() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 go to Files</B></li>
	*<li><B>Step: testUser1 upload a new .odp file with public access</B></li>
	...
	*/
	...
	public void filePreview_odpFile_uploaded() {
		...
		for(String filter : TEST_FILTERS) {
			...
			HomepageValid.verifyFilesNewsStoryIsDisplayedInAS(ui, driver, fileUploadEvent, baseFileOdp);
	...
	/**
	* filePreview_odsFile_uploaded() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 go to Files</B></li>
	*<li><B>Step: testUser1 upload a new .ods file with public access</B></li>
	*<li><B>Step: testUser2 go to Homepage / Updates / Discover / All & Files</B></li>
	*<li><B>Step: testUser2 look at the story for the file uploaded</B></li>
	*<li><B>Verify: Verify the file uploaded event displays a preview image of the first page of the file added as the first item, with a details/description box underneath it</B></li>
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/B912DEDAF63B194A85257D0E00508BDA">TTT - FILE PREVIEW - 00010 - File Created - Compatible Public File - Preview image appears</a></li>
	...
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void filePreview_odsFile_uploaded() {
		...
		// Create the file details to be verified
		String fileDetails = baseFileOds.getRename() + baseFileOds.getExtension();
		String nameDetails = testUser1.getDisplayName() + profilesAPIUser1.getUUID();
		...
		for(String filter : TEST_FILTERS) {
			...
			// Verify that the file uploaded news story is displayed in all views
			HomepageValid.verifyFilesNewsStoryIsDisplayedInAS(ui, driver, fileUploadEvent, baseFileOds);
			
			// Verify that the file details box is displayed in all views
			HomepageValid.verifyFileDetailsBox(ui, driver, baseFileOds, fileDetails, nameDetails, null, true);
		}		
		ui.endTest();	
	}
}