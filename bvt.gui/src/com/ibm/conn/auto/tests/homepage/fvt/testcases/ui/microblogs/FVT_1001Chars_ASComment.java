...
public class FVT_1001Chars_ASComment extends SetUpMethodsFVT {
	...
	/**
	* addStatusUpdate_Comment1001_AS() 
	*<ul>
	...
	*<li><B>Step: Post a comment with more than 1000 characters on the status update from the Activity Stream</B></li>
	...
	*/
	...
	public void addStatusUpdate_Comment1001_AS(){
		...
		// User 1 will now enter a comment which is too long (ie. greater than 1000 characters) into the comment input field of the AS for the posted status message
		String user1InvalidComment = Data.getData().Chars1001;
		boolean warningDisplayedAndLinkDisabled = ProfileEvents.addStatusUpdateCommentTooLongUsingUI(ui, driver, user1StatusUpdate, testUser1, user1InvalidComment);
