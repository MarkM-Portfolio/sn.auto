...
public class FVT_PostHashtags extends SetUpMethodsFVT {
	...
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/BBD0626254378EDE852579420040EC8D">TTT - Activity Stream Sharebox - 00013 - User should be able to post a status with a hashtag</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void addStatusUpdateHashtag_AS(){
		...
		// User 1 will now post a status update with hashtag
		String user1Hashtag = "#" + ProfileEvents.generateValidHashtag();
		String user1StatusUpdateWithHashtag = Data.getData().commonStatusUpdate + Helper.genStrongRand() + " " + user1Hashtag;
		ProfileEvents.addStatusUpdateUsingUI(ui, testUser1, user1StatusUpdateWithHashtag, true);
		
		// Verify that User 1's status update with hashtag is displayed in all views
		HomepageValid.verifyItemsInASUsingMultipleFilters(ui, driver, new String[]{user1StatusUpdateWithHashtag}, TEST_FILTERS, true);
					
		ui.endTest();
	}

	/**
	* addStatusUpdate_CommentHashtag_EE() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: Log into Connections</B></li>
	*<li><B>Step: Go to Homepage / Updates / I'm Following / All</B></li>
	*<li><B>Step: Post a status update in the sharebox</B></li>
	*<li><B>Step: Post a comment with a hashtag on the status update in the EE</B></li>
	...
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void addStatusUpdate_CommentHashtag_EE(){
		...
		// User 1 will now post a comment to the status update which includes a hashtag
		String user1Hashtag = "#" + ProfileEvents.generateValidHashtag();
		String user1CommentWithHashtag = Data.getData().commonComment + Helper.genStrongRand() + " " + user1Hashtag;
		UIEvents.addEECommentUsingUI(ui, testUser1, user1StatusUpdate, user1CommentWithHashtag);
		...
		HomepageValid.verifyItemsInASUsingMultipleFilters(ui, driver, new String[]{commentOnMessageEvent, user1StatusUpdate, user1CommentWithHashtag}, TEST_FILTERS, true);
