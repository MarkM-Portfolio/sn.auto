...
public class FVT_PostHashtags_ASComment extends SetUpMethodsFVT {
	...
	/**
	* addStatusUpdate_CommentHashtag_AS() 
	*<ul>
	...
	*<li><B>Step: Post a comment with a hashtag on the status update from the Activity Stream</B></li>
	...
	*/
	...
	public void addStatusUpdate_CommentHashtag_AS() {
		...
		ProfileEvents.addStatusUpdateCommentUsingUI(ui, testUser1, user1StatusUpdate, user1CommentWithHashtag);
		...
		for(String filter : TEST_FILTERS) {
			...
			HomepageValid.verifyItemsInAS(ui, driver, new String[]{user1StatusUpdate, user1CommentWithHashtag}, null, true);
		}
		ui.endTest();
	}
}