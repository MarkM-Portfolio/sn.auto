...
public class FVT_PostMicroblogs extends SetUpMethodsFVT {
	...
	*/
	...
	public void addStatusUpdate_AS(){
		...
		// User 1 will now post a status update
		String user1StatusUpdateUsingUI = Data.getData().commonStatusUpdate + Helper.genStrongRand();
	...
	*/
	@Test(groups = {"fvtonprem", "fvtcloud"})
	public void addStatusUpdate_Comment_EE(){
