...
public class FVT_PostSpecialCharacters_ASComment extends SetUpMethodsFVT {
	...
	/**
	* addStatusUpdate_SpecChars_Comment_AS() 
	*<ul>
	...
	*<li><B>Step: Post a comment with special characters on the status update from the Activity Stream</B></li>
	...
	*/
	...
	public void addStatusUpdate_SpecChars_Comment_AS() {
		...
		// User 1 will now post a comment with spacial characters included to the status update
		...
		HomepageValid.verifyItemsInASUsingMultipleFilters(ui, driver, new String[]{user1StatusUpdate, user1Comment}, TEST_FILTERS, true);
