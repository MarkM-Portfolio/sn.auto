...
public class FVT_VisitorModel_EE_Comment_StatusUpdate_NoVisitor_ModeratedCommunity extends SetUpMethods2{
	private static Logger log = LoggerFactory.getLogger(FVT_VisitorModel_EE_Comment_StatusUpdate_NoVisitor_ModeratedCommunity.class);
	...
	/**
	* visitor_ee_comment_modCommunity_noVisitor_statusUpdateLike() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 log in to Communities</B></li>
	*<li><B>Step: testUser1 creates a moderated community adding testUser3 as a member</B></li>
	*<li><B>Step: testUser3 follow the community</B></li>
	*<li><B>Step: testUser1 creates a community status update</B></li>
	*<li><B>Step: testUser1 likes the status update</B></li>
	...
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/03F0CCF711EB811F85257C89004CC26E">TTT - VISITORS NOT ADDED TO COMMUNITY- EE - 00042 - MODERATED COMMUNITY.STATUS.UPDATE.LIKED</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtvisitor"})
	public void visitor_ee_comment_modCommunity_noVisitor_statusUpdateLike() {
		
		String testName = ui.startTest();
		
		log.info("INFO: " + testUser1.getDisplayName() + " creates a moderated community");
		BaseCommunity baseCommunity = CommunityBaseBuilder.buildBaseCommunity(testName + Helper.genStrongRand(), Access.MODERATED);
		Community moderatedCommunity = executeCommonCreateAndFollowCommunitySteps(baseCommunity);
		...
		String communityStatusUpdateId = communityAPIUser1.addStatusUpdate(moderatedCommunity, communityStatusUpdate);
		
		log.info("INFO: " + testUser1.getDisplayName() + " likes the status update");
		testUser1Profile.like(communityStatusUpdateId);
		...
		communityAPIUser1.deleteCommunity(moderatedCommunity);
		ui.endTest();
	}
