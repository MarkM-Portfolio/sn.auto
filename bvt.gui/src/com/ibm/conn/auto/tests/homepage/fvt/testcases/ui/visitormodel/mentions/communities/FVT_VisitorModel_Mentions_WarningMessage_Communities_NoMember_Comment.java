...
public class FVT_VisitorModel_Mentions_WarningMessage_Communities_NoMember_Comment extends SetUpMethods2{
	...
	/**
	* visitorModel_mentionsWarning_publicCommunity_noMembers_comment() 
	*<ul>
	...
	*<li><B>Step: testUser1 add a status update to the public community</B></li>
	...
	*<li><B>Verify: Verify the warning "The following people mentioned will not be able to see the message as they are in a different organization" appears</B></li>
	*<li><B>Verify: Verify there is no mentions event</B></li>
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/7FA5CCCDCAA6FF8C85257C8D00467258">TTT - MENTIONS - 00016 - VISITORS - WARNING MESSAGE WHEN VISITOR CANT BE MENTIONED - PUBLIC COMMUNITY COMMENT - NON MEMBER</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtvisitor"})
	public void visitorModel_mentionsWarning_publicCommunity_noMembers_comment() {
		...
		CommunityEvents.addStatusUpdate(publicCommunity, communitiesAPIUser1, profilesAPIUser1, statusUpdate);
		...
		boolean commentPostedCorrectly = CommunityEvents.loginAndNavigateToCommunityAndAddStatusUpdateCommentWithMentions(publicCommunity, baseCommunity, ui, driver, uiCo, statusUpdate, testUser1, communitiesAPIUser1, mentions, false, true);
