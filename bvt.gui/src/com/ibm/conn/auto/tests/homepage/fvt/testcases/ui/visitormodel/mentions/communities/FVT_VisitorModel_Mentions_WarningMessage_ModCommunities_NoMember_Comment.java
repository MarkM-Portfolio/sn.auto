...
public class FVT_VisitorModel_Mentions_WarningMessage_ModCommunities_NoMember_Comment extends SetUpMethods2{
	...
	/**
	* visitorModel_mentionsWarning_modCommunity_noMembers_comment() 
	*<ul>
	...
	*<li><B>Step: testUser1 add a moderate community status update</B></li>
	...
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/179A84EDABD0B41085257C8D00467259">TTT - MENTIONS - 00017 - VISITORS - WARNING MESSAGE WHEN VISITOR CANT BE MENTIONED - MODERATE COMMUNITY COMMENT - NON MEMBER</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtvisitor"})
	public void visitorModel_mentionsWarning_modCommunity_noMembers_comment() {
		...
		CommunityEvents.addStatusUpdate(moderatedCommunity, communitiesAPIUser1, profilesAPIUser1, statusUpdate);
		...
		boolean commentPostedCorrectly = CommunityEvents.loginAndNavigateToCommunityAndAddStatusUpdateCommentWithMentions(moderatedCommunity, baseCommunity, ui, driver, uiCo, statusUpdate, testUser1, communitiesAPIUser1, mentions, false, true);
