...
public class FVT_VisitorModel_SharedExternallyHeader_CommunityEvents_VisitorAdded extends SetUpMethods2{
	private static Logger log = LoggerFactory.getLogger(FVT_VisitorModel_SharedExternallyHeader_CommunityEvents_VisitorAdded.class);
	...
	/**
	* visitor_sharedExternallyHeader_privateCommunity_visitorAdded_communityCreated() 
	*<ul>
	...
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/7EB9BE2E24029F7C85257C8A003566C6">TTT - VISITORS - ACTIVITY STREAM - 00044 - SHARED EXTERNALLY HEADER - COMMUNITY EVENTS- PRIVATE COMMUNITY</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtvisitor"})
	public void visitor_sharedExternallyHeader_privateCommunity_visitorAdded_communityCreated() {
		...
		// Verify that all news story components are displayed and all 'Shared Externally' components are displayed
		verifySharedExternallyIsDisplayedInAllFilter(newsStory, baseCommunity.getDescription());
		...
		// Verify that all news story components are displayed and all 'Shared Externally' components are displayed
		verifySharedExternallyIsDisplayedInCommunitiesFilter(newsStory, baseCommunity.getDescription());
	...
	/**
	* visitor_sharedExternallyHeader_privateCommunity_visitorAdded_bookmarkAdded() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 log in to Communities</B></li>
	*<li><B>Step: testUser1 creates a private community adding a visitor as a member (User 2) and User 3 as a member</B></li>
	...
	*/
	@Test(groups = {"fvtvisitor"})
	public void visitor_sharedExternallyHeader_privateCommunity_visitorAdded_bookmarkAdded() {
		...
		// Verify that all news story components are displayed and all 'Shared Externally' components are displayed
		verifySharedExternallyIsDisplayedInAllFilter(newsStory, baseBookmark.getDescription());
		verifySharedExternallyIsDisplayedInCommunitiesFilter(newsStory, baseBookmark.getDescription());
	...
	/**
	* visitor_sharedExternallyHeader_privateCommunity_visitorAdded_feedAdded() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 log in to Communities</B></li>
	*<li><B>Step: testUser1 creates a private community adding a visitor as a member (User 2) and User 3 as a member</B></li>
	...
	*/
	@Test(groups = {"fvtvisitor"})
	public void visitor_sharedExternallyHeader_privateCommunity_visitorAdded_feedAdded() {
		...
		// Verify that all news story components are displayed and all 'Shared Externally' components are displayed
		verifySharedExternallyIsDisplayedInAllFilter(newsStory, baseFeed.getDescription());
		verifySharedExternallyIsDisplayedInCommunitiesFilter(newsStory, baseFeed.getDescription());
	...
	/**
	* visitor_sharedExternallyHeader_privateCommunity_visitorAdded_communityCreated_linkDesc() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 log in to Communities</B></li>
	*<li><B>Step: testUser1 creates a private community with a link and formatting in the main body/description adding a visitor as a member (User 2) and User 3 as a member</B></li>
	*<li><B>Step: testUser3 log into Homepage / Updates / I'm Following / All - verification point</B></li>
	*<li><B>Verify: 'Shared externally' header in a yellow background appears beside the event title</B></li>
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/7EB9BE2E24029F7C85257C8A003566C6">TTT - VISITORS - ACTIVITY STREAM - 00044 - SHARED EXTERNALLY HEADER - COMMUNITY EVENTS- PRIVATE COMMUNITY</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtvisitor"})
	public void visitor_sharedExternallyHeader_privateCommunity_visitorAdded_communityCreated_linkDesc() {
	...
	/**
	* visitor_sharedExternallyHeader_privateCommunity_visitorAdded_relatedCommunity() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 log in to Communities</B></li>
	*<li><B>Step: testUser1 creates a private community adding a visitor as a member (User 2) and User 3 as a member</B></li>
	...
	*/
	@Test(groups = {"fvtvisitor"})
	public void visitor_sharedExternallyHeader_privateCommunity_visitorAdded_relatedCommunity() {
	...
	/**
	* visitor_sharedExternallyHeader_privateCommunity_visitorAdded_standaloneEvent() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 log in to Communities</B></li>
	*<li><B>Step: testUser1 creates a private community adding a visitor as a member (User 2) and User 3 as a member</B></li>
	...
	*/
	@Test(groups = {"fvtvisitor"})
	public void visitor_sharedExternallyHeader_privateCommunity_visitorAdded_standaloneEvent() {
		...
		// Verify that all news story components are displayed and all 'Shared Externally' components are displayed
		verifySharedExternallyIsDisplayedInAllFilter(newsStory, baseEvent.getDescription());
		verifySharedExternallyIsDisplayedInCommunitiesFilter(newsStory, baseEvent.getDescription());
	...
	/**
	* visitor_sharedExternallyHeader_privateCommunity_visitorAdded_repeatingEvent() 
	*<ul>
	*<li><B>Info: It can be assumed that each testcase starts with login and ends with logout and the browser being closed</B></li>
	*<li><B>Step: testUser1 log in to Communities</B></li>
	*<li><B>Step: testUser1 creates a private community adding a visitor as a member (User 2) and User 3 as a member</B></li>
	...
	*/
	@Test(groups = {"fvtvisitor"})
	public void visitor_sharedExternallyHeader_privateCommunity_visitorAdded_repeatingEvent() {
	 ...
	 * Step 2: User 1 adds User 2 and User 3 to the restricted community
	...
	private Community executeCommonRestrictedCommunitySetupSteps(BaseCommunity baseCommunity) {
		...
		communityAPIUser1.addMemberToCommunity(testUser2, community, StringConstants.Role.MEMBER);
	...
	/**
	 * Executes all required verifications for the 'Shared Externally' component are displayed
	 * 
	 ...
	 */
	private void verifySharedExternallyIsDisplayedInAllFilter(String newsStoryContent, String newsStoryDescription) {
	 ...
	 * @param newsStoryDescription - The description displayed with the news story (null if no description displayed)
	 */
	private void verifySharedExternallyIsDisplayedInCommunitiesFilter(String newsStoryContent, String newsStoryDescription) {
