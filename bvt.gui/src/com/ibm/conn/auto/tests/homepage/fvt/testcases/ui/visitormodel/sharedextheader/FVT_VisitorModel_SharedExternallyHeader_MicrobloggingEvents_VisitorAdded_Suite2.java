...
public class FVT_VisitorModel_SharedExternallyHeader_MicrobloggingEvents_VisitorAdded_Suite2 extends SetUpMethods2 {
	
	private static Logger log = LoggerFactory.getLogger(FVT_VisitorModel_SharedExternallyHeader_MicrobloggingEvents_VisitorAdded_Suite2.class);
	...
	/**
	* visitor_sharedExternallyHeader_privateCommunity_visitorAdded_statusUpdateComment() 
	*<ul>
	...
	*/
	...
	public void visitor_sharedExternallyHeader_privateCommunity_visitorAdded_statusUpdateComment() {
		...
		verifySharedExternallyIsDisplayedInAllFilters(newsStory, statusUpdate, comment, null);
