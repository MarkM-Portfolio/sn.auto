...
public class FVT_VisitorModel_SharedExternallyHeader_MicrobloggingEvents_VisitorAdded_Suite4 extends SetUpMethods2 {

	private static Logger log = LoggerFactory.getLogger(FVT_VisitorModel_SharedExternallyHeader_MicrobloggingEvents_VisitorAdded_Suite4.class);
	...
	/**
	* visitor_sharedExternallyHeader_privateCommunity_visitorAdded_statusUpdate_commentWarning2() 
	*<ul>
	...
	*<li><B>Step: testUser3 follows the community</B></li>
	*<li><B>Step: testUser1 creates a community status update</B></li>
	*<li><B>Step: testUser1 adds a comment to the status update</B></li>
	...
	*<li><a HREF="Notes://CAMDB01/85257863004CBF81/A3B1F5A7FAF7FB158525703C006F870C/38D8E356383DEA7985257C86003B94E9">TTT - VISITORS - ACTIVITY STREAM - 00015 - PRIVATE COMMUNITY.STATUS.UPDATE.COMMENTED</a></li>
	*</ul>
	*/
	@Test(groups = {"fvtvisitor"})
	public void visitor_sharedExternallyHeader_privateCommunity_visitorAdded_statusUpdate_commentWarning2() {
		...
		log.info("INFO: " + testUser1.getDisplayName() + " will now comment on the status update");
		String comment = Data.getData().commonComment + Helper.genStrongRand();
		String commentId = communityAPIUser1.commentOnStatusUpdate(statusUpdateId, comment);
		...
		testUser1Profile.deleteSUComment(statusUpdateId, commentId);
