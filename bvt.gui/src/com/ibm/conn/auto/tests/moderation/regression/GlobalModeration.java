...
public class GlobalModeration extends SetUpMethods2 {

	private static Logger log = LoggerFactory.getLogger(GlobalModeration.class);

	//	private static CommunitiesUI communityui;
		private ModerationUI modui;
		private BlogsUI blogui;
		private TestConfigCustom cfg;
		private User comOwner;
		...
		private APIFileHandler apiFileMember;
		private APIFileHandler apiFileOwner;
		private APIBlogsHandler apiBlogOwner;
		private APIBlogsHandler apiBlogMember;
		private APIForumsHandler apiForumOwner;
		private APIForumsHandler apiForumMember;
		...
		public void setUp() throws Exception {
			...
			log.info("INFO: Using test user as community owner: " + comOwner.getDisplayName());
			comMember = cfg.getUserAllocator().getUser();
			log.info("INFO: Using test user as community member: " + comMember.getDisplayName());
			moderator = cfg.getUserAllocator().getModUser();
			log.info("INFO: Using test user as moderator: " + moderator.getDisplayName());
		 ...
		 * <li><B>Step: </B>Login to moderation by global moderator</li>
		...
		public void testBlogEntryPreModeration() throws Exception {
			...
			//GUI
			// navigate to the Global Moderation and log in global moderator 
			modui.loadComponent(Data.getData().ComponentModeration);
			modui.login(moderator);
		...
		public void testEditFlaggedAndQuarantinedEntry() {
			...
			Moderation_LeftNav_Menu.FCBLOGSENTRIES.select(modui);
			modui.fluentWaitTextPresent(entryTitles[0]);
			modui.openLandingPage(entryTitles[0]);
		...
		public void testEditFlaggedAndQuarantinedPost() {
			...
			log.info("INFO: Open quarantined topic " + newTopicTitle);
			modui.openLandingPage(newTopicTitle);
			driver.navigate().refresh();
			modui.EditForumPost();
		...
		/**
		 * <ul>
		 * <li><B>Info: </B>Test verifying Pre-moderation(Approve/Reject/Delete) actions for stand-alone Forums Topic</li>
		 * <li><B>Step: </B>Preparing data by creating 1 stand-alone forum by API using community owner</li>
		 * <li><B>Step: </B>Then creating 4 forum topics by API using community member</li>
		 * <li><B>Step: </B>Login to moderation by global moderator</li>
		 * <li><B>Step: </B>Click "Content approval -> Forums -> Posts" on left navigation</li>
		 * <li><B>Verify: </B>Verify the 4 items are listed on Moderation page</li>
		 * <li><B>Step: </B>Click "item1" link to open the landing page of it and click "Approve" button</li>
		...
		@Test(groups = { "regression" } , enabled=false )
		public void testForumTopicPreModeration_SA() throws Exception {
			log.info("INFO: test Stand-Alone Forum Topic Pre-moderation");
			...
			//prepare forum post for pre-moderation test
			log.info("INFO: prepare forum posts for pre-moderation test");
			prepareForumTopicDataPre_SA(topics);
			//GUI
			// navigate to the Global Moderation and log in global moderator 
			modui.loadComponent(Data.getData().ComponentModeration);
			modui.login(moderator);
		...
		/**
		 * <ul>
		 * <li><B>Info: </B>Test verifying Post-moderation(Quarantine/Dismiss/Delete) actions for Forums topic of stand-alone</li>
		 * <li><B>Step: </B>Preparing data by creating 1 stand-alone forum and then 4 forums topics, and flag 4 topics by API using community owner</li>
		 * <li><B>Step: </B>Login to moderation by global moderator</li>
		 * <li><B>Step: </B>Click "Flagged Content -> Forums -> Posts" on left navigation</li>
		 * <li><B>Verify: </B>Verify the 4 items are listed on Moderation page</li>
		 * <li><B>Step: </B>Click "item1" link to open the landing page of it and click "Dismiss" button</li>
		...
		@Test(groups = { "regression" } , enabled=false )
		public void testForumTopicPostModeration_SA() throws Exception {
			log.info("INFO: test Forum posts Post-moderation");
			...
			//prepare Forum posts for post-moderation test
			log.info("INFO: prepare Forums post for post-moderation test");
			prepareForumTopicDataPost_SA(topics);
		...
		/**
		 * <ul>
		 * <li><B>Info: </B>Test verifying Pre-moderation(Approve/Reject/Delete) actions for Blog Entry & comments of Stand-alone</li>
		 * <li><B>Step: </B>Preparing data by creating 1 standlone blog by API using community owner</li>
		 * <li><B>Step: </B>Creating 1 blog entry by API using community owner and then add one autor in this blog</li>
		 * <li><B>Step: </B>Login to the standalone blog by author and create 4 comments to the entry, and then create 4 entries</li>
		 * <li><B>Step: </B>Login to moderation by global moderator</li>
		 * <li><B>Verify: </B>Verify the 4 items are listed on Moderation page</li>
		 * <li><B>Step: </B>Click "item1" link to open the landing page of it and click "Approve" button</li>
		 * <li><B>Verify: </B>Verify the item is approved successfully without error</li>
		 ...
		 * <li><B>Verify: </B>Verify the item is deleted successfully without error</li>
		 * <li><B>Step: </B>Click "Content Approval -> Blogs -> Comments" on left navigation</li>
		 * <li><B>Verify: </B>Verify the 4 comment items are listed on Moderation page</li>
		 * <li><B>Step: </B>Repeat 4 steps as last several steps to entries</li>
		 * </ul>
		 * 
		 * @throws Exception
		 */
		...
		@Test(groups = { "regression" } , enabled=false )
		public void testBlogEntryAndCommentPreModeration_SA() throws Exception {
			log.info("INFO: test Blog entry Pre-moderation");
			...
			//Prepare the pending community blog entries 
			prepareBlogDataPre_SA(entryTitles,entryComments);
		...
		/**
		 * <ul>
		 * <li><B>Info: </B>Test verifying Post-moderation(Quarantine/Dismiss/Delete) actions for Blog comment of stand-alone</li>
		 * <li><B>Step: </B>Preparing data by creating 1 standalone blog and then create 4 entries and 4 comments and then flag them by API using community owner</li>
		 * <li><B>Step: </B>Login to moderation by global moderator</li>
		 * <li><B>Verify: </B>Verify the 4 items are listed on Moderation page</li>
		 * <li><B>Step: </B>Click "item1" link to open the landing page of it and click "Dismiss" button</li>
		 * <li><B>Verify: </B>Verify the item is Dismissed successfully without error</li>
		...
		@Test(groups = { "regression" } , enabled=false )
		public void testBlogEntryAndCommentPostModeration_SA() throws Exception {
			log.info("INFO: test Blog entry Post-moderation");
			...
			//prepare blog entries for post-moderation test
			log.info("INFO: prepare blog entries for post-moderation test");
			prepareBlogDataPost_SA(entryTitles,entryComments );
		...
		private void prepareBlogEntryDataPost(String entryTitles[]) {
			...
			BlogPost blogPostEntry = null;
			for (int i = 0; i < entryTitles.length; i++) {
				BaseBlogPost NewEntry1 = new BaseBlogPost.Builder(entryTitles[i])
						.tags("ModerationBlog").content(entryTitles[i]).build();

				// Add Post to blog
				blogPostEntry = apiCommunityOwner.createBlogEntry(
						NewEntry1, comAPI);
				Assert.assertTrue(blogPostEntry != null,
						"Failed to create blog entry in community using API.");
			}
		...
		private void prepareFileCommentDataPost(String[] comments) {
			...
			for (int i = 0; i < comments.length; i++) {
				fComment = new FileComment(comments[i]);
				publishComment = apiFileOwner.CreateFileComment(
						fileEntry, fComment, comAPI);
	...
	private void prepareForumTopicDataPre_SA(String topic[]) {
			// for creating the Forums topic
			apiForumOwner = new APIForumsHandler(serverURL, comOwner.getUid(),
					comOwner.getPassword());
			...
			Forum testForum = apiForumOwner.createForum(baseForum); 
			...
			for (int i = 0; i < topic.length; i++) {
				...
				log.info("INFO: " + comMember.getDisplayName() + " creating Forum Topic as user1 (API)");
				ForumTopic forumTopic = apiForumMember.createForumTopic(baseTopic);

				// Add Post to blog
				Assert.assertTrue(forumTopic != null,
						"Failed to create stand-alone Forum topic using API.");

			}
		}

	private void prepareForumTopicDataPost_SA(String topic[]) {
		// for creating the Forums topic
	...
	private void prepareBlogDataPre_SA(String entryTitles[], String entryComments[]) {
		// for creating the blog entry
		...
		BaseBlog baseBlog = new BaseBlog.Builder(blogName, Data.getData().BlogsAddress1 + Helper.genDateBasedRand())
				...
				.description("Test description for blog moderation")
				.build();
		...
		.content("Test description for moderation").build();

		// Add Post to blog
		BlogPost ownerBlogPost = apiBlogOwner.createBlogEntry(ownerEntry, blog);
		...
		apiBlogMember = new APIBlogsHandler(serverURL,
				comMember.getUid(), comMember.getPassword());
		...
		for (int i = 0; i < entryTitles.length; i++) {
			...
			BlogPost blogPostEntry = apiBlogMember.createBlogEntry(NewEntry1, blog);
			
			Assert.assertTrue(blogPostEntry != null,
					"Failed to create blog entry in blog using API.");
		}


		for (int i = 0; i < entryComments.length; i++) {
			BlogComment blogComment = apiBlogMember.createBlogComment(entryComments[i], ownerBlogPost);
			Assert.assertTrue(blogComment != null,
					"Failed to create blog comment in blog using API.");
		}
	}


	private void prepareBlogDataPost_SA(String entryTitles[], String entryComments[]) {
		// for creating the blog entry
		...
		for (int i = 0; i < entryTitles.length; i++) {
			...
			BlogPost blogPostEntry = apiBlogOwner.createBlogEntry(NewEntry1, blog);
		...
		for (int i = 0; i < entryComments.length; i++) {
			BlogComment blogComment = apiBlogOwner.createBlogComment(entryComments[i], ownerBlogPost);
			Assert.assertTrue(blogComment != null,
					"Failed to create blog comment in blog using API.");
		}
		apiBlogOwner.flagBlogComments(ownerEntryTitle);
	}
