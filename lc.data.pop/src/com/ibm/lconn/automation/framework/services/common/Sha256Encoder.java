...
public class Sha256Encoder
{
	...
	/**
	 * @param input String to be trimmed, lower-cased, and hashed.
	 * See comments for method
	 *        hashLowercaseString(String input, String charset, boolean trim)
	 * In this method, the charset is assumed to be UTF-8
	 * The string is lower-cased (in Locale.ENLGISH)
	 * @param trim Whether to trim leading & trailing whitespace 
	 *   true - the input string is trimmed; false - not trimmed
	 * @return
	 */
	...
	/**
	 * @param input String to be trimmed, lower-cased, and hashed.
	 * @param charset used specified char set eg UTF-8
	 * @param trim Whether to trim leading & trailing whitespace 
	 *   true - the input string is trimmed; false - not trimmed
	 * The input string is lower-cased (in Locale.ENLGISH)
	 * Then a byte[] is extracted from the string in the indicated charset
	 * This byte[] is hashed by a SHA-256 MessageDigest.
	 * The first 16 bytes (128 bits) of the resulting hash value is hex encoded
	...
	/**
	 * @param input String to be trimmed and hashed.
	 * @param charset used specified char set eg UTF-8
	 * @param trim Whether to trim leading & trailing whitespace 
	 *   true - the input string is trimmed; false - not trimmed
	 * @param lowerCase Whether to lower-case the input string (in Locale.ENLGISH)
	 * Then a byte[] is extracted from the string in the indicated charset
	 * This byte[] is hashed by a SHA-256 MessageDigest.
	 * The first 16 bytes (128 bits) of the resulting hash value is hex encoded
	 * @return the resulting value
