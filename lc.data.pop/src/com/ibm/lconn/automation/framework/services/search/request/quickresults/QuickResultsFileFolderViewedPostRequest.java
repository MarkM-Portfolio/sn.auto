...
public class QuickResultsFileFolderViewedPostRequest extends QuickResultsWithContainerPostRequest{


	public final static String QUICK_RESULTS_SOURCE_FILE = "FILES";
	public final static String QUICK_RESULTS_ITYPE_FILE_FOLDER = "FOLDER";
	...
	*/
	...
	public QuickResultsFileFolderViewedPostRequest(String fileId, String fileTitle,
		...
		super(fileId, QUICK_RESULTS_SOURCE_FILE, fileTitle, fileCreatorId, fileCreateTs,
				fileLink, QUICK_RESULTS_ITYPE_FILE_FOLDER, fileContainerId, fileContainerTitle,
				fileContainerLink);
	}
	@Override
