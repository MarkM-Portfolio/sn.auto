...
case $APPLICATION_NAME in
	activities)
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/oa.test/bvt/ext/libs
	...
	blogs)
		...
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/blogs.test/bvt/ext/libs
		JARS_TO_INSTRUMENT[${index}]='blogs.app.core.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/blogs.test/bvt/ext/libs
		JARS_TO_INSTRUMENT[${index}]='lc.search.seedlist.retriever.blogs.jar'
		index=`expr ${index} + 1`
		;;

	bookmarks)
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/dogear.test/ut/ext/libs
		JARS_TO_INSTRUMENT[${index}]='dogear.api.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/dogear.test/ut/ext/libs
		JARS_TO_INSTRUMENT[${index}]='dogear.config.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/dogear.test/ut/ext/libs
		JARS_TO_INSTRUMENT[${index}]='dogear.svc.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/dogear.test/ut/ext/libs
		JARS_TO_INSTRUMENT[${index}]='dogear.taglib.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/dogear.test/ut/ext/libs
		JARS_TO_INSTRUMENT[${index}]='dogear.webui.jar'
		index=`expr ${index} + 1`
		;;
	
	calendar)
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/calendar.test/unittest/ext/libs
	...
	communities)
		...
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/comm.seedlist/retriever/lib
		JARS_TO_INSTRUMENT[${index}]='lc.search.seedlist.retriever.communities.jar'
		index=`expr ${index} + 1`
		;;

	extensibility)
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/ExtRegComp/lib
		JARS_TO_INSTRUMENT[${index}]='scee.jar'
		index=`expr ${index} + 1`
		;;

	forums)
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/forum.data/distribution/lib
		JARS_TO_INSTRUMENT[${index}]='forum.data.distribution.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/forum.data/population/lib
		JARS_TO_INSTRUMENT[${index}]='forum.data.population.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/forum.data/event.handler/lib
		JARS_TO_INSTRUMENT[${index}]='forum.event.handler.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/forum.api/lib
		JARS_TO_INSTRUMENT[${index}]='forum.api.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/forum.conf/lib
		JARS_TO_INSTRUMENT[${index}]='forum.conf.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/forum.svc/lib
		JARS_TO_INSTRUMENT[${index}]='forum.svc.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/forum.install/migrate/lib
		JARS_TO_INSTRUMENT[${index}]='forum.migrate.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/forum.web/lib
		JARS_TO_INSTRUMENT[${index}]='forum.web.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/forum.seedlist/retriever/lib
		JARS_TO_INSTRUMENT[${index}]='lc.search.seedlist.retriever.forums.jar'
		index=`expr ${index} + 1`
		;;
	...
	homepage)
		...
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/homepage.tests/junit_jars/classpath.homepage
		JARS_TO_INSTRUMENT[${index}]='homepage.model.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/homepage.tests/junit_jars/classpath.homepage
		JARS_TO_INSTRUMENT[${index}]='homepage.service.layer.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/homepage.tests/junit_jars/classpath.homepage
		JARS_TO_INSTRUMENT[${index}]='homepage.taglib.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/homepage.tests/junit_jars/classpath.homepage
		JARS_TO_INSTRUMENT[${index}]='homepage.utils.jar'
		index=`expr ${index} + 1`

		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/homepage.tests/junit_jars/classpath.homepage
		JARS_TO_INSTRUMENT[${index}]='homepage.web.jar'
		index=`expr ${index} + 1`
	...
	infra)
		...
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/lc.beacon/lib
		JARS_TO_INSTRUMENT[${index}]='lc.beacon.jar'
		index=`expr ${index} + 1`
		;;
	
	metrics)
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/lc.metrics.config/lib
		JARS_TO_INSTRUMENT[${index}]='lc.metrics.config.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/lc.metrics.datasync/lib
		JARS_TO_INSTRUMENT[${index}]='lc.metrics.datasync.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/lc.metrics.persistence/lib
		JARS_TO_INSTRUMENT[${index}]='lc.metrics.persistence.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/lc.metrics.reportgeneration/lib
		JARS_TO_INSTRUMENT[${index}]='lc.metrics.reportgeneration.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/lc.metrics.scheduler/lib
		JARS_TO_INSTRUMENT[${index}]='lc.metrics.scheduler.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/lc.metrics.ui/lib
		JARS_TO_INSTRUMENT[${index}]='lc.metrics.ui.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/lc.metrics.writer/lib
		JARS_TO_INSTRUMENT[${index}]='lc.metrics.writer.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/lc.metrics.writer.queue/lib
		JARS_TO_INSTRUMENT[${index}]='lc.metrics.writer.queue.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/lc.metrics.common/lib
		JARS_TO_INSTRUMENT[${index}]='lc.metrics.common.jar'
		index=`expr ${index} + 1`
	
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/lc.metrics.events/lib
		JARS_TO_INSTRUMENT[${index}]='lc.metrics.events.jar'
		index=`expr ${index} + 1`
		;;

	mobile)
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/mobile.apns/lib
		JARS_TO_INSTRUMENT[${index}]='mobile.apns.jar'
		index=`expr ${index} + 1`

		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/mobile.filediff.rsync/lib
		JARS_TO_INSTRUMENT[${index}]='mobile.filediff.rsync.jar'
		index=`expr ${index} + 1`

		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/mobile.filediff.web/lib
		JARS_TO_INSTRUMENT[${index}]='mobile.filediff.web.jar'
		index=`expr ${index} + 1`
		;;
	...
	news)
		...
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/news.test/junit_jars/classpath.news
		JARS_TO_INSTRUMENT[${index}]='news.consumer.jar'
		index=`expr ${index} + 1`
				
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/news.test/junit_jars/classpath.news
		JARS_TO_INSTRUMENT[${index}]='news.core.service.jar'
		index=`expr ${index} + 1`
		
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/news.test/junit_jars/classpath.news
		JARS_TO_INSTRUMENT[${index}]='news.spring.context.jar'
		index=`expr ${index} + 1`
		 
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/news.test/junit_jars/classpath.news
		JARS_TO_INSTRUMENT[${index}]='news.core.data.jar'
		index=`expr ${index} + 1`
		 
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/news.test/junit_jars/classpath.news
		JARS_TO_INSTRUMENT[${index}]='news.core.service.microblogging.jar'
		index=`expr ${index} + 1`
		...
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/news.test/junit_jars/classpath.news
		JARS_TO_INSTRUMENT[${index}]='news.common.jar'
		index=`expr ${index} + 1`
		 
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/news.test/junit_jars/classpath.news
		JARS_TO_INSTRUMENT[${index}]='news.notify.service.jar'
		index=`expr ${index} + 1`
		 
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/news.test/junit_jars/classpath.news
		JARS_TO_INSTRUMENT[${index}]='news.notify.consumer.jar'
		index=`expr ${index} + 1`
		...
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/news.test/junit_jars/classpath.news
		JARS_TO_INSTRUMENT[${index}]='news.mailin.publish.jar'
		index=`expr ${index} + 1`
		 
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/news.test/junit_jars/classpath.news
		JARS_TO_INSTRUMENT[${index}]='news.mailin.consumer.jar'
		index=`expr ${index} + 1`
		 
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/news.test/junit_jars/classpath.news
		JARS_TO_INSTRUMENT[${index}]='news.migrate.jar'
		index=`expr ${index} + 1`
		...
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/news.test/junit_jars/classpath.news
		JARS_TO_INSTRUMENT[${index}]='news.web.common.jar'
		index=`expr ${index} + 1`
		 
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/news.test/junit_jars/classpath.news
		JARS_TO_INSTRUMENT[${index}]='news.web.core.jar'
		index=`expr ${index} + 1`
		 
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/news.test/junit_jars/classpath.news
		JARS_TO_INSTRUMENT[${index}]='news.analyzer.jar'
		index=`expr ${index} + 1`
        ...
        placesCatalog)
                ...
                DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/catalog.search.engine/lib
                JARS_TO_INSTRUMENT[${index}]='catalog.search.engine.jar'
                index=`expr ${index} + 1`
    
                DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/catalog.search.mdb/lib
                JARS_TO_INSTRUMENT[${index}]='catalog.search.mdb.jar'
                index=`expr ${index} + 1`

                DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/catalog.utils/lib
                JARS_TO_INSTRUMENT[${index}]='catalog.utils.jar'
                index=`expr ${index} + 1`

                DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/comm.catalog.web.resources/eclipse/plugins
	...
	richTextEditors)
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/spring-social-connections/lib
		JARS_TO_INSTRUMENT[${index}]='spring-social-connections.jar'
		index=`expr ${index} + 1`

		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/rte-web/lib
	...
	search)
		...
		DIR_WITH_JARS_TO_INSTRUMENT[${index}]=${DIR_BUILD}/search.tools/solr.index.backup/lib
		JARS_TO_INSTRUMENT[${index}]='solr.index.backup.jar'
		index=`expr ${index} + 1`
		;;	
