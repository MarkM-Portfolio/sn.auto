...
# Now find and unzip the latest "promoted" Infra fe.zip.
INFRA_BUILD_LABEL=`cat ${DAILY_BUILD_ROOT_DIR}/${BUILD_STREAM}_Infra/BVTBuildLabel.txt`
INFRA_DAILY_BUILD_ROOT_DIR=/net/mlsa2/ibm/releng/workplace/dailybuilds/${BUILD_STREAM}_Infra
FE_ZIP_FILE="${INFRA_DAILY_BUILD_ROOT_DIR}/${INFRA_BUILD_LABEL}/repository/${FE_NAME}/fe.zip"
