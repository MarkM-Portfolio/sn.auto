...
collect_from_sn_infra() {
    ...
    cp -v ${from_dir}/lc.config.svc/config.scripts/jython/gadgetAdmin.py \
       xkit/bin_lc_admin
    cp -v -r "${from_dir}/lc.config.svc/config.files/00000000-0000-0000-0000-000000000000" \
       "xkit/configuration"
}
...
collect_from_sn_infra_ui() {
    ...
    rm -v xkit/common.provision.web/com.ibm.social.appext.web.resources_*.jar
    cp -v ${from_dir}/build/appext.web.resources/eclipse/plugins/com.ibm.social.appext.web.resources_*.jar xkit/common.provision.web
