...
# Since APPDIR is an array, it can't be exported, therefore it won't be in the
# environment. So need to get it via an argument.
DIR=$1
...
EAR_FILE_PATH=${CI_HOME}/${SRC}/${APPDIR}/build/oa.ear/ear.prod/lib/${EAR_FILE_NAME}
