...
EAR_FILE_NAME=widget.container.ear
EAR_FILE_PATH=/local/ci/infra/src/sn.infra/lwp/build/lc.shindig.serverapi/ear/lib/${EAR_FILE_NAME}

DEPLOY_SCRIPT_NAME=updt-widgetcontainer.py
